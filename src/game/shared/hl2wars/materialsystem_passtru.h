...
#if defined(HL2WARS_ASW_DLL) || defined(SWARM_DLL)
...
public:
	...
	virtual bool				SupportsShadowDepthTextures( void ) { return m_pBaseMaterialsPassThru->SupportsShadowDepthTextures(); }
	virtual void				BeginUpdateLightmaps( void ) { m_pBaseMaterialsPassThru->BeginUpdateLightmaps(); }
	virtual void				EndUpdateLightmaps( void ) { m_pBaseMaterialsPassThru->EndUpdateLightmaps(); }
	...
	virtual bool				SupportsFetch4( void ) { return m_pBaseMaterialsPassThru->SupportsFetch4(); }
