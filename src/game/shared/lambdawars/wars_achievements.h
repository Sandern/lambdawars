...
enum WarsAchievements_e 
{
	...
	ACHIEVEMENT_WARS_INFESTATION,
	ACHIEVEMENT_WARS_PINGPONG,
	ACHIEVEMENT_WARS_STRIDERS,
	ACHIEVEMENT_WARS_SUPPRESSION,
	ACHIEVEMENT_WARS_C4,
	ACHIEVEMENT_WARS_DOG,
	ACHIEVEMENT_WARS_FRIENDLYFIRE,
	ACHIEVEMENT_WARS_GRENADE,
	ACHIEVEMENT_WARS_PARTISAN,
	ACHIEVEMENT_WARS_MISSION_WASTE
};
