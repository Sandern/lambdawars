...
BOOST_PYTHON_MODULE(_ndebugoverlay){
    ...
    { //::NDebugOverlay::Cone
        ...
        typedef void ( *Cone_function_type )( ::Vector const &,::Vector const &,float,float,int,int,int,int,bool,float );
        
        bp::def( 
            "Cone"
            , Cone_function_type( &::NDebugOverlay::Cone )
            , ( bp::arg("position"), bp::arg("axis"), bp::arg("angleRadians"), bp::arg("length"), bp::arg("r"), bp::arg("g"), bp::arg("b"), bp::arg("a"), bp::arg("bNoDepthTest"), bp::arg("flDuration") ) );
    
    }

    { //::NDebugOverlay::Cross
    
        typedef void ( *Cross_function_type )( ::Vector const &,float,int,int,int,bool,float );
        
        bp::def( 
            "Cross"
            , Cross_function_type( &::NDebugOverlay::Cross )
            , ( bp::arg("position"), bp::arg("radius"), bp::arg("r"), bp::arg("g"), bp::arg("b"), bp::arg("bNoDepthTest"), bp::arg("flDuration") ) );
    ...
    { //::NDebugOverlay::PurgeTextOverlays
        ...
        typedef void ( *PurgeTextOverlays_function_type )(  );
        
        bp::def( 
            "PurgeTextOverlays"
            , PurgeTextOverlays_function_type( &::NDebugOverlay::PurgeTextOverlays ) );
