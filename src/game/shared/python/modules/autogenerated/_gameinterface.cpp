...
struct BSPHeader_t_wrapper : BSPHeader_t, bp::wrapper< BSPHeader_t > {

    BSPHeader_t_wrapper(BSPHeader_t const & arg )
    : BSPHeader_t( arg )
      , bp::wrapper< BSPHeader_t >(){
        // copy constructor
    ...
    pyplusplus_lumps_wrapper( ::BSPHeader_t & inst ){
...
struct py_player_info_s_wrapper : py_player_info_s, bp::wrapper< py_player_info_s > {
    ...
    static pyplusplus::containers::static_sized::array_1_t< long unsigned int, 4>
    pyplusplus_customFiles_wrapper( ::py_player_info_s & inst ){
        return pyplusplus::containers::static_sized::array_1_t< long unsigned int, 4>( inst.customFiles );
    }
...
BOOST_PYTHON_MODULE(_gameinterface){
    ...
    bp::enum_< AppStatus>("AppStatus")
        .value("AS_NOT_AVAILABLE", AS_NOT_AVAILABLE)
        .value("AS_AVAILABLE_REQUIRES_EXTRACTION", AS_AVAILABLE_REQUIRES_EXTRACTION)
        .value("AS_AVAILABLE", AS_AVAILABLE)
        .export_values()
        ;
    ...
    bp::enum_< MountApps>("MountApps")
        .value("APP_L4D1", APP_L4D1)
        .value("APP_L4D2", APP_L4D2)
        .value("APP_PORTAL2", APP_PORTAL2)
        .value("APP_DOTA", APP_DOTA)
        .value("APP_CSGO", APP_CSGO)
        .value("APP_DEARESTHER", APP_DEARESTHER)
        .value("NUM_APPS", NUM_APPS)
        .export_values()
        ;
    ...
    bp::enum_< SearchPathAdd_t>("SearchPathAdd_t")
        ...
        .value("PATH_ADD_TO_TAIL_ATINDEX", PATH_ADD_TO_TAIL_ATINDEX)
        .export_values()
        ;

    { //::BSPHeader_t
        typedef bp::class_< BSPHeader_t_wrapper > BSPHeader_t_exposer_t;
        BSPHeader_t_exposer_t BSPHeader_t_exposer = BSPHeader_t_exposer_t( "BSPHeader_t" );
        bp::scope BSPHeader_t_scope( BSPHeader_t_exposer );
        BSPHeader_t_exposer.def_readwrite( "ident", &BSPHeader_t::ident );
        pyplusplus::containers::static_sized::register_array_1< ::lump_t, 64, bp::return_internal_reference< > >( "__array_1__scope_lump_t_64" );
        { //BSPHeader_t::lumps [variable], type=lump_t[64]
        
            typedef pyplusplus::containers::static_sized::array_1_t< ::lump_t, 64> ( *array_wrapper_creator )( ::BSPHeader_t & );
            
            BSPHeader_t_exposer.add_property( "lumps"
    ...
    bp::class_< C_RecipientFilter, bp::bases< IRecipientFilter >, boost::noncopyable >( "C_RecipientFilter", bp::no_init )    
        ...
        .def( 
            ...
            , (void ( ::C_RecipientFilter::* )( ::CBitVec< 64 > & ) )( &::C_RecipientFilter::AddPlayersFromBitMask )
            , ( bp::arg("playerbits") ) )    
        .def( 
            "AddRecipient"
    ...
    { //::ConVarRef
        ...
        { //::ConVarRef::GetBaseName
        
            typedef char const * ( ::ConVarRef::*GetBaseName_function_type )(  ) const;
            
            ConVarRef_exposer.def( 
                "GetBaseName"
                , GetBaseName_function_type( &::ConVarRef::GetBaseName ) );
        ...
        { //::ConVarRef::GetColor
            ...
            typedef ::Color ( ::ConVarRef::*GetColor_function_type )(  ) const;
            
            ConVarRef_exposer.def( 
                "GetColor"
                , GetColor_function_type( &::ConVarRef::GetColor ) );
        ...
        { //::ConVarRef::GetSplitScreenPlayerSlot
        
            typedef int ( ::ConVarRef::*GetSplitScreenPlayerSlot_function_type )(  ) const;
            
            ConVarRef_exposer.def( 
                "GetSplitScreenPlayerSlot"
                , GetSplitScreenPlayerSlot_function_type( &::ConVarRef::GetSplitScreenPlayerSlot ) );
        ...
        { //::ConVarRef::SetValue
            ...
            typedef void ( ::ConVarRef::*SetValue_function_type )( ::Color ) ;
    ...
    bp::class_< PyConVar, boost::noncopyable >( "ConVar", bp::init< char const *, char const *, bp::optional< int > >(( bp::arg("name"), bp::arg("defaultvalue"), bp::arg("flags")=(int)(0) )) )    
        ...
        .def( 
            "SetValue"
            , (void ( ::PyConVar::* )( char const * ) )( &::PyConVar::SetValue )
            , ( bp::arg("value") ) )    
        .def( 
            "SetValue"
            , (void ( ::PyConVar::* )( float ) )( &::PyConVar::SetValue )
            , ( bp::arg("value") ) )    
        .def( 
            "SetValue"
            , (void ( ::PyConVar::* )( int ) )( &::PyConVar::SetValue )
            , ( bp::arg("value") ) )    
        .def( 
            "AddFlags"
    ...
    bp::class_< PyVEngineClient_wrapper >( "VEngineClient" )    
        ...
        .def( 
            ...
            , (float ( ::PyVEngineClient::* )( int,int ) )( &::PyVEngineClient::GetScreenAspectRatio )
            , ( bp::arg("viewportWidth"), bp::arg("viewportHeight") ) )    
        .def( 
            "GetScreenSize"
        ...
        .def( 
            "ReadConfiguration"
            , (void ( ::PyVEngineClient::* )( int const,bool const ) )( &::PyVEngineClient::ReadConfiguration )
            , ( bp::arg("iController"), bp::arg("readDefault") ) )    
        .def( 
            "ServerCommand"
    ...
    { //::py_player_info_s
        ...
        pyplusplus::containers::static_sized::register_array_1< long unsigned int, 4 >( "__array_1_long_unsigned_int_4" );
        { //py_player_info_s::customFiles [variable], type=CRC32_t[4]
        
            typedef pyplusplus::containers::static_sized::array_1_t< long unsigned int, 4> ( *array_wrapper_creator )( ::py_player_info_s & );
    ...
    { //::CommandLine
        ...
        bp::def( 
            "CommandLine"
            , CommandLine_function_type( &::CommandLine )
    ...
    { //::GetAppStatus
        ...
        typedef ::AppStatus ( *GetAppStatus_function_type )( ::MountApps );
        
        bp::def( 
            "GetAppStatus"
            , GetAppStatus_function_type( &::GetAppStatus )
            , ( bp::arg("app") ) );
    ...
    { //::HasApp
        ...
        typedef bool ( *HasApp_function_type )( ::MountApps );
        
        bp::def( 
            "HasApp"
            , HasApp_function_type( &::HasApp )
            , ( bp::arg("app") ) );
    ...
    { //::Plat_MSTime
        ...
        typedef ::uint32 ( *Plat_MSTime_function_type )(  );
    ...
    { //::PyGetMapHeader
        ...
        typedef ::BSPHeader_t ( *GetMapHeader_function_type )( char const * );
...
struct CServerGameDLL_wrapper : CServerGameDLL, bp::wrapper< CServerGameDLL > {

    CServerGameDLL_wrapper(CServerGameDLL const & arg )
    : CServerGameDLL( arg )
      , bp::wrapper< CServerGameDLL >(){
        // copy constructor
        
    }

    CServerGameDLL_wrapper()
    : CServerGameDLL()
      , bp::wrapper< CServerGameDLL >(){
        // null constructor
    ...
    ::KeyValues * FindLaunchOptionByValue( ::KeyValues * pLaunchOptions, char const * szLaunchOption ){
        return CServerGameDLL::FindLaunchOptionByValue( pLaunchOptions, szLaunchOption );
    }
...
BOOST_PYTHON_MODULE(_gameinterface){
    ...
    bp::class_< CRecipientFilter, bp::bases< IRecipientFilter >, boost::noncopyable >( "CRecipientFilter", bp::no_init )    
        ...
        .def( 
            "AddPlayersFromBitMask"
            , (void ( ::CRecipientFilter::* )( ::CBitVec< 64 > & ) )( &::CRecipientFilter::AddPlayersFromBitMask )
            , ( bp::arg("playerbits") ) )    
        .def( 
            "AddRecipient"
        ...
        .def( 
            "AddRecipient"
            , (void ( ::CRecipientFilter::* )( int ) )( &::CRecipientFilter::AddRecipient )
            , ( bp::arg("index") ) )    
        .def( 
            "AddRecipientsByPAS"
        ...
        .def( 
            ...
            , (void ( ::CRecipientFilter::* )( ::CBitVec< 64 > & ) )( &::CRecipientFilter::RemovePlayersFromBitMask )
            , ( bp::arg("playerbits") ) )    
        .def( 
            "RemoveRecipient"
        ...
        .def( 
            "RemoveSplitScreenPlayers"
            , (void ( ::CRecipientFilter::* )(  ) )( &::CRecipientFilter::RemoveSplitScreenPlayers ) )    
        .def( 
            "Reset"
    ...
    bp::class_< CServerGameDLL_wrapper >( "CServerGameDLL" )    
        .def( 
            "ApplyGameSettings"
            , (void ( ::CServerGameDLL::* )( ::KeyValues * ) )( &::CServerGameDLL::ApplyGameSettings )
            , ( bp::arg("pKV") ) )    
        .def( 
        ...
        .def( 
            ...
            , (::KeyValues * ( CServerGameDLL_wrapper::* )( ::KeyValues *,char const * ) )(&CServerGameDLL_wrapper::FindLaunchOptionByValue)
            , ( bp::arg("pLaunchOptions"), bp::arg("szLaunchOption") )
            , bp::return_value_policy< bp::return_by_value >() )    
        .def( 
            "GameFrame"
        ...
        .def( 
            "GetMatchmakingGameData"
            , (void ( ::CServerGameDLL::* )( char *,::size_t ) )( &::CServerGameDLL::GetMatchmakingGameData )
            , ( bp::arg("buf"), bp::arg("bufSize") ) )    
        .def( 
            "GetMatchmakingTags"
            , (void ( ::CServerGameDLL::* )( char *,::size_t ) )( &::CServerGameDLL::GetMatchmakingTags )
            , ( bp::arg("buf"), bp::arg("bufSize") ) )    
        .def( 
            "GetSaveComment"
        ...
        .def( 
            "PostToolsInit"
            , (void ( ::CServerGameDLL::* )(  ) )( &::CServerGameDLL::PostToolsInit ) )    
        .def( 
            "PreClientUpdate"
        ...
        .def( 
            ...
            , (void ( ::CServerGameDLL::* )( bool ) )( &::CServerGameDLL::ServerHibernationUpdate )
            , ( bp::arg("bHibernating") ) )    
        .def( 
            "ShouldHideServer"
            , (bool ( ::CServerGameDLL::* )(  ) )( &::CServerGameDLL::ShouldHideServer ) )    
        .def( 
            "ShouldPreferSteamAuth"
            , (bool ( ::CServerGameDLL::* )(  ) )( &::CServerGameDLL::ShouldPreferSteamAuth ) )    
        .def( 
            "ShouldTimeoutClient"
            , (bool ( ::CServerGameDLL::* )( int,float ) )( &::CServerGameDLL::ShouldTimeoutClient )
            , ( bp::arg("nUserID"), bp::arg("flTimeSinceLastReceived") ) )    
        .def( 
            "SupportsRandomMaps"
            , (bool ( ::CServerGameDLL::* )(  ) )( &::CServerGameDLL::SupportsRandomMaps ) )    
        .def( 
            "SupportsSaveRestore"
            , (bool ( ::CServerGameDLL::* )(  ) )( &::CServerGameDLL::SupportsSaveRestore ) )    
        .def( 
            "Think"
    ...
    { //::AddToDownloadables
        ...
        typedef bool ( *AddToDownloadables_function_type )( char const * );
        
        bp::def( 
            "AddToDownloadables"
            , AddToDownloadables_function_type( &::AddToDownloadables )
            , ( bp::arg("file") ) );
