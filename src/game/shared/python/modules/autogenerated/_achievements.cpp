...
BOOST_PYTHON_MODULE(_achievements){
    ...
    bp::enum_< WarsAchievements_e>("WarsAchievements_e")
        ...
        .value("ACHIEVEMENT_WARS_INFESTATION", ACHIEVEMENT_WARS_INFESTATION)
        .value("ACHIEVEMENT_WARS_PINGPONG", ACHIEVEMENT_WARS_PINGPONG)
        .value("ACHIEVEMENT_WARS_STRIDERS", ACHIEVEMENT_WARS_STRIDERS)
        .value("ACHIEVEMENT_WARS_SUPPRESSION", ACHIEVEMENT_WARS_SUPPRESSION)
        .value("ACHIEVEMENT_WARS_C4", ACHIEVEMENT_WARS_C4)
        .value("ACHIEVEMENT_WARS_DOG", ACHIEVEMENT_WARS_DOG)
        .value("ACHIEVEMENT_WARS_FRIENDLYFIRE", ACHIEVEMENT_WARS_FRIENDLYFIRE)
        .value("ACHIEVEMENT_WARS_GRENADE", ACHIEVEMENT_WARS_GRENADE)
        .value("ACHIEVEMENT_WARS_PARTISAN", ACHIEVEMENT_WARS_PARTISAN)
        .value("ACHIEVEMENT_WARS_MISSION_WASTE", ACHIEVEMENT_WARS_MISSION_WASTE)
        .export_values()
        ;
