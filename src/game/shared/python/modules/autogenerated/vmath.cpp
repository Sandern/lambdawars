...
BOOST_PYTHON_MODULE(vmath){
    ...
    { //::Vector
        ...
        { //::Vector::IsZeroFast
            ...
            typedef bool ( ::Vector::*IsZeroFast_function_type )(  ) const;
            
            Vector_exposer.def( 
                "IsZeroFast"
                , IsZeroFast_function_type( &::Vector::IsZeroFast ) );
        
        }
        { //::Vector::LargestComponent
        
            typedef int ( ::Vector::*LargestComponent_function_type )(  ) const;
            
            Vector_exposer.def( 
                "LargestComponent"
                , LargestComponent_function_type( &::Vector::LargestComponent ) );
        ...
        { //::Vector::LengthRecipFast
        
            typedef ::vec_t ( ::Vector::*LengthRecipFast_function_type )(  ) const;
            
            Vector_exposer.def( 
                "LengthRecipFast"
                , LengthRecipFast_function_type( &::Vector::LengthRecipFast ) );
        ...
        { //::Vector::ProjectOnto
            ...
            typedef ::Vector ( ::Vector::*ProjectOnto_function_type )( ::Vector const & ) ;
            
            Vector_exposer.def( 
                "ProjectOnto"
                , ProjectOnto_function_type( &::Vector::ProjectOnto )
                , ( bp::arg("onto") ) );
    ...
    bp::class_< matrix3x4_t >( "matrix3x4_t", bp::init< >() )    
        ...
        .def( 
            "SetOrigin"
            , (void ( ::matrix3x4_t::* )( ::Vector const & ) )( &::matrix3x4_t::SetOrigin )
            , ( bp::arg("p") ) );
    ...
    { //::FastFToC
        ...
        typedef unsigned char ( *FastFToC_function_type )( float );
    ...
    { //::IsPowerOfTwo
        ...
        typedef bool ( *IsPowerOfTwo_function_type )( int );
    ...
    { //::Q_log2
        ...
        typedef ::size_t ( *Q_log2_function_type )( unsigned int );
    ...
    { //::VectorMax
        ...
        typedef ::Vector ( *VectorMax_function_type )( ::Vector const &,::Vector const & );
    ...
    { //::VectorMin
        ...
        typedef ::Vector ( *VectorMin_function_type )( ::Vector const &,::Vector const & );
