...
BOOST_PYTHON_MODULE(_entitiesmisc){
    ...
    bp::enum_< FireBulletsFlags_t>("FireBulletsFlags_t")
        .value("FIRE_BULLETS_FIRST_SHOT_ACCURATE", FIRE_BULLETS_FIRST_SHOT_ACCURATE)
        .value("FIRE_BULLETS_DONT_HIT_UNDERWATER", FIRE_BULLETS_DONT_HIT_UNDERWATER)
        .value("FIRE_BULLETS_ALLOW_WATER_SURFACE_IMPACTS", FIRE_BULLETS_ALLOW_WATER_SURFACE_IMPACTS)
        .value("FIRE_BULLETS_TEMPORARY_DANGER_SOUND", FIRE_BULLETS_TEMPORARY_DANGER_SOUND)
    ...
    { //::PyRestoreHelper
        typedef bp::class_< PyRestoreHelper > PyRestoreHelper_exposer_t;
        PyRestoreHelper_exposer_t PyRestoreHelper_exposer = PyRestoreHelper_exposer_t( "PyRestoreHelper", bp::no_init );
...
BOOST_PYTHON_MODULE(_entitiesmisc){
    ...
    { //::PyRestoreHelper
        ...
        { //::PyRestoreHelper::ReadOutputEvent
            ...
            typedef void ( ::PyRestoreHelper::*ReadOutputEvent_function_type )( ::PyOutputEvent & ) ;
            
            PyRestoreHelper_exposer.def( 
                "ReadOutputEvent"
                , ReadOutputEvent_function_type( &::PyRestoreHelper::ReadOutputEvent )
                , ( bp::arg("ev") ) );
