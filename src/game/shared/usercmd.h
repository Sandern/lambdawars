...
#ifdef HL2WARS_DLL
		m_vMouseAim.Init();
		m_vCameraOffset.Init();
		vecmovetoposition.Init();
		directmove = false;
#endif //HL2WARS_DLL
	}
...
#ifdef HL2WARS_DLL
		m_vMouseAim			= src.m_vMouseAim;
		m_vCameraOffset		= src.m_vCameraOffset;
		vecmovetoposition	= src.vecmovetoposition;
		directmove			= src.directmove;
#endif //HL2WARS_DLL
...
#ifdef HL2WARS_DLL
		CRC32_ProcessBuffer( &crc, &m_vMouseAim, sizeof( m_vMouseAim ) );
		CRC32_ProcessBuffer( &crc, &m_vCameraOffset, sizeof( m_vCameraOffset ) );
		CRC32_ProcessBuffer( &crc, &vecmovetoposition, sizeof( vecmovetoposition ) );
		CRC32_ProcessBuffer( &crc, &directmove, sizeof( directmove ) );
#endif //HL2WARS_DLL
