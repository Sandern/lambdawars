...
public:
	...
	int CreateNavArea( const Vector &nwCorner, const Vector &neCorner, const Vector &seCorner, const Vector &swCorner );
...
public:
	...
	bool TryMergeSingleArea( CNavArea *pArea, float tolerance = FLT_EPSILON );
