...
//-----------------------------------------------------------------------------
const Vector &MainViewOrigin( int nSlot = 0 );
const QAngle &MainViewAngles( int nSlot = 0 );
const Vector &PrevMainViewOrigin( int nSlot = 0 );
const QAngle &PrevMainViewAngles( int nSlot = 0 );
const VMatrix &MainWorldToViewMatrix( int nSlot = 0 );
const Vector &MainViewForward( int nSlot = 0 );
const Vector &MainViewRight( int nSlot = 0 );
const Vector &MainViewUp( int nSlot = 0 );
