...
#include "../../game/client/python/modules/autogenerated/_vguicontrols/CWars_Model_Panel_pypp.hpp"
...
typedef PyVGUIHandle<CWars_Model_Panel> CWars_Model_PanelHANDLE;

struct ptr_CWars_Model_Panel_to_handle : bp::to_python_converter<CWars_Model_Panel *, ptr_CWars_Model_Panel_to_handle>
{
    static PyObject* convert( CWars_Model_Panel *s )
    {
        if( s ) 
        {
            PyObject *pObject = GetPyPanel( s );
            if( pObject )
                ...
                return bp::incref( bp::object( CWars_Model_PanelHANDLE(s) ).ptr() );
        }
        else
        {
            return bp::incref( Py_None );
...
struct CWars_Model_Panel_to_handle : bp::to_python_converter<CWars_Model_Panel, CWars_Model_Panel_to_handle>
{
    static PyObject* convert( const CWars_Model_Panel &s )
    {
        PyObject *pObject = GetPyPanel( &s );
        if( pObject )
            return bp::incref( pObject );
...
struct handle_to_CWars_Model_Panel
{
    handle_to_CWars_Model_Panel()
    {
        bp::converter::registry::insert(
            &extract_CWars_Model_Panel,
            bp::type_id< CWars_Model_Panel >()
            );
    }
    
    static void* extract_CWars_Model_Panel(PyObject* op)
    {
        PyBaseVGUIHandle &h = bp::extract< PyBaseVGUIHandle & >(op);
        return h.Get();
    }
...
BOOST_PYTHON_MODULE(_vguicontrols){
    ...
    register_CWars_Model_Panel_class();
    ...
    ptr_CWars_Model_Panel_to_handle();

    CWars_Model_Panel_to_handle();
