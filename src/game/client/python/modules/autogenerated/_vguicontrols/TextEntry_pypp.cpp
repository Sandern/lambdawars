...
struct TextEntry_wrapper : PyPanel, vgui::TextEntry, bp::wrapper< vgui::TextEntry > {
    ...
    virtual void ApplySchemeSettings( ::vgui::IScheme * pScheme ){
        ...
        if( func_ApplySchemeSettings.ptr() != Py_None )
            try {
                ...
                PyErr_Print();
                this->vgui::TextEntry::ApplySchemeSettings( boost::python::ptr(pScheme) );
            }
        else
            this->vgui::TextEntry::ApplySchemeSettings( boost::python::ptr(pScheme) );
    }
    ...
    virtual void default_ApplySchemeSettings( ::vgui::IScheme * pScheme ){
        vgui::TextEntry::ApplySchemeSettings( boost::python::ptr(pScheme) );
    }
    ...
    virtual void MoveCursor( int line, int pixelsAcross ) {
        ...
        if( GetCurrentThreadId() != g_hPythonThreadID )
            Error( "MoveCursor: Client? %d. Thread ID is not the same as in which the python interpreter is initialized! %d != %d. Tell a developer.\n", CBaseEntity::IsClient(), g_hPythonThreadID, GetCurrentThreadId() );
        #endif // _DEBUG/PY_CHECKTHREADID
        #endif // _WIN32
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling MoveCursor( line, pixelsAcross ) of Class: vgui::TextEntry\n");
    ...
    virtual void SetDisabledBgColor( ::Color col ) {
        ...
        #elif defined(PY_CHECKTHREADID)
        if( GetCurrentThreadId() != g_hPythonThreadID )
            Error( "SetDisabledBgColor: Client? %d. Thread ID is not the same as in which the python interpreter is initialized! %d != %d. Tell a developer.\n", CBaseEntity::IsClient(), g_hPythonThreadID, GetCurrentThreadId() );
        #endif // _DEBUG/PY_CHECKTHREADID
        #endif // _WIN32
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling SetDisabledBgColor( col ) of Class: vgui::TextEntry\n");
        #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
    ...
    virtual void SetEnabled( bool state ) {
        ...
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling SetEnabled( state ) of Class: vgui::TextEntry\n");
        #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
    ...
    virtual void SetMultiline( bool state ) {
        ...
        #elif defined(PY_CHECKTHREADID)
        if( GetCurrentThreadId() != g_hPythonThreadID )
            Error( "SetMultiline: Client? %d. Thread ID is not the same as in which the python interpreter is initialized! %d != %d. Tell a developer.\n", CBaseEntity::IsClient(), g_hPythonThreadID, GetCurrentThreadId() );
        #endif // _DEBUG/PY_CHECKTHREADID
        #endif // _WIN32
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling SetMultiline( state ) of Class: vgui::TextEntry\n");
        #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
    ...
    virtual void SetText( wchar_t const * wszText ) {
        ...
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling SetText( wszText ) of Class: vgui::TextEntry\n");
        #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
    ...
    virtual void SetText( char const * text ) {
        ...
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling SetText( text ) of Class: vgui::TextEntry\n");
        #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
        bp::override func_SetText = this->get_override( "SetText" );
        if( func_SetText.ptr() != Py_None )
            try {
    ...
    virtual void SetVerticalScrollbar( bool state ) {
        ...
        #elif defined(PY_CHECKTHREADID)
        if( GetCurrentThreadId() != g_hPythonThreadID )
            Error( "SetVerticalScrollbar: Client? %d. Thread ID is not the same as in which the python interpreter is initialized! %d != %d. Tell a developer.\n", CBaseEntity::IsClient(), g_hPythonThreadID, GetCurrentThreadId() );
        #endif // _DEBUG/PY_CHECKTHREADID
        #endif // _WIN32
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling SetVerticalScrollbar( state ) of Class: vgui::TextEntry\n");
        #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
    ...
    virtual void PaintBackground(  ) {
        if( !IsSBufferEnabled() || ShouldRecordSBuffer( m_PaintBackgroundCallBuffer ) )
        {
            ...
            #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
            if( py_log_overrides.GetBool() )
                Msg("Calling PaintBackground(  ) of Class: vgui::vgui::TextEntry\n");
            #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
    ...
    ~TextEntry_wrapper( void ) { g_PythonPanelCount--; /*::PyDeletePanel( this, GetPySelf() );*/ }
