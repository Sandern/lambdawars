...
struct C_Beam_wrapper : C_Beam, bp::wrapper< C_Beam > {
    ...
    virtual void OnDataChanged( ::DataUpdateType_t updateType ) {
        PY_OVERRIDE_CHECK( C_Beam, OnDataChanged )
        PY_OVERRIDE_LOG( _entities, C_Beam, OnDataChanged )
    ...
    virtual void Precache(  ) {
        PY_OVERRIDE_CHECK( C_Beam, Precache )
        PY_OVERRIDE_LOG( _entities, C_Beam, Precache )
    ...
    virtual bool Simulate(  ) {
        PY_OVERRIDE_CHECK( C_Beam, Simulate )
        PY_OVERRIDE_LOG( _entities, C_Beam, Simulate )
    ...
    virtual void Spawn(  ) {
        PY_OVERRIDE_CHECK( C_Beam, Spawn )
        PY_OVERRIDE_LOG( _entities, C_Beam, Spawn )
...
#endif // _WIN32
        PY_OVERRIDE_LOG( _entities, C_Beam, GetClientClass )
    ...
    static int m_lifeState_Get( C_Beam const & inst ) { return inst.m_lifeState; }

    static void m_lifeState_Set( C_Beam & inst, int val ) { inst.m_lifeState = val; }

    static int m_takedamage_Get( C_Beam const & inst ) { return inst.m_takedamage; }

    static void m_takedamage_Set( C_Beam & inst, int val ) { inst.m_takedamage = val; }
