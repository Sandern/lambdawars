...
struct C_BaseGrenade_wrapper : C_BaseGrenade, bp::wrapper< C_BaseGrenade > {
    ...
    virtual ClientClass* GetClientClass() {
        PY_OVERRIDE_CHECK( C_BaseGrenade, GetClientClass )
    ...
    static int m_lifeState_Get( C_BaseGrenade const & inst ) { return inst.m_lifeState; }

    static void m_lifeState_Set( C_BaseGrenade & inst, int val ) { inst.m_lifeState = val; }

    static int m_takedamage_Get( C_BaseGrenade const & inst ) { return inst.m_takedamage; }
...
void register_C_BaseGrenade_class(){
    ...
    { //::C_BaseGrenade
        ...
        { //::C_BaseAnimating::PyPostOnNewModel
            ...
            typedef void ( C_BaseGrenade_wrapper::*default_PostOnNewModel_function_type )(  ) ;
            
            C_BaseGrenade_exposer.def( 
                "PostOnNewModel"
                , PostOnNewModel_function_type(&::C_BaseAnimating::PyPostOnNewModel)
                , default_PostOnNewModel_function_type(&C_BaseGrenade_wrapper::default_PostOnNewModel) );
