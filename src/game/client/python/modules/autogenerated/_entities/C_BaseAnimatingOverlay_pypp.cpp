...
struct C_BaseAnimatingOverlay_wrapper : C_BaseAnimatingOverlay, bp::wrapper< C_BaseAnimatingOverlay > {
    ...
    virtual bool TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                ...
                #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
                if( py_log_overrides.GetBool() )
                    Msg("Calling TestCollision( boost::ref(ray), mask, boost::ref(trace) ) of Class: C_BaseAnimatingOverlay\n");
                #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
                ...
                if( func_TestCollision.ptr() != Py_None )
                    try {
                        ...
                        PyErr_Print();
                        return this->C_BaseAnimatingOverlay::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
                    }
                else
                    return this->C_BaseAnimatingOverlay::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
            ...
            bool default_TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                return C_BaseAnimatingOverlay::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
...
void register_C_BaseAnimatingOverlay_class(){
    ...
    { //::C_BaseAnimatingOverlay
        ...
        { //::C_BaseAnimatingOverlay::TestCollision
            
                typedef bool ( ::C_BaseAnimatingOverlay::*TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;
                typedef bool ( C_BaseAnimatingOverlay_wrapper::*default_TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;

                C_BaseAnimatingOverlay_exposer.def( 
                    "TestCollision"
                    , TestCollision_function_type(&::C_BaseAnimatingOverlay::TestCollision)
                    , default_TestCollision_function_type(&C_BaseAnimatingOverlay_wrapper::default_TestCollision)
