...
struct C_BaseAnimatingOverlay_wrapper : C_BaseAnimatingOverlay, bp::wrapper< C_BaseAnimatingOverlay > {
    ...
    virtual ClientClass* GetClientClass() {
        PY_OVERRIDE_CHECK( C_BaseAnimatingOverlay, GetClientClass )
...
void register_C_BaseAnimatingOverlay_class(){
    ...
    { //::C_BaseAnimatingOverlay
        ...
        { //::C_BaseEntity::Restore
            ...
            typedef int ( C_BaseAnimatingOverlay_wrapper::*default_Restore_function_type )( ::IRestore & ) ;
            
            C_BaseAnimatingOverlay_exposer.def( 
                "Restore"
                , Restore_function_type(&::C_BaseEntity::Restore)
                , default_Restore_function_type(&C_BaseAnimatingOverlay_wrapper::default_Restore)
                , ( bp::arg("restore") ) );
