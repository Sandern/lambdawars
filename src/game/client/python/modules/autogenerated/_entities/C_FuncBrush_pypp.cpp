...
#include "C_FuncBrush_pypp.hpp"

namespace bp = boost::python;

struct C_FuncBrush_wrapper : C_FuncBrush, bp::wrapper< C_FuncBrush > {

    C_FuncBrush_wrapper()
    : C_FuncBrush()
      , bp::wrapper< C_FuncBrush >(){
        // null constructor
    ...
    virtual void OnDataChanged( ::DataUpdateType_t type ) {
        ...
        if( py_log_overrides.GetBool() )
            Msg("Calling OnDataChanged( type ) of Class: C_FuncBrush\n");
        ...
        if( func_OnDataChanged.ptr() != Py_None )
            try {
                ...
                PyErr_Print();
                this->C_FuncBrush::OnDataChanged( type );
            }
        else
            this->C_FuncBrush::OnDataChanged( type );
    }
    ...
    void default_OnDataChanged( ::DataUpdateType_t type ) {
        C_FuncBrush::OnDataChanged( type );
    }
    ...
    virtual bool TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                ...
                #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
                if( py_log_overrides.GetBool() )
                    Msg("Calling TestCollision( boost::ref(ray), mask, boost::ref(trace) ) of Class: C_FuncBrush\n");
                #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
                ...
                if( func_TestCollision.ptr() != Py_None )
                    try {
                        ...
                        PyErr_Print();
                        return this->C_FuncBrush::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
                    }
                else
                    return this->C_FuncBrush::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
            ...
            bool default_TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                return C_FuncBrush::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
...
void register_C_FuncBrush_class(){
    ...
    { //::C_FuncBrush
        typedef bp::class_< C_FuncBrush_wrapper, bp::bases< C_BaseEntity >, boost::noncopyable > C_FuncBrush_exposer_t;
        C_FuncBrush_exposer_t C_FuncBrush_exposer = C_FuncBrush_exposer_t( "C_FuncBrush" );
        bp::scope C_FuncBrush_scope( C_FuncBrush_exposer );
        { //::C_FuncBrush::OnDataChanged
        
            typedef void ( ::C_FuncBrush::*OnDataChanged_function_type )( ::DataUpdateType_t ) ;
            typedef void ( C_FuncBrush_wrapper::*default_OnDataChanged_function_type )( ::DataUpdateType_t ) ;
            
            C_FuncBrush_exposer.def( 
                "OnDataChanged"
                , OnDataChanged_function_type(&::C_FuncBrush::OnDataChanged)
                , default_OnDataChanged_function_type(&C_FuncBrush_wrapper::default_OnDataChanged)
                , ( bp::arg("type") ) );
        ...
        { //::C_BaseEntity::Activate
            ...
            typedef void ( C_FuncBrush_wrapper::*default_Activate_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "Activate"
                , Activate_function_type(&::C_BaseEntity::Activate)
                , default_Activate_function_type(&C_FuncBrush_wrapper::default_Activate) );
        
        }
        { //::C_BaseEntity::AddToEntityList
        
            typedef void ( C_FuncBrush_wrapper::*AddToEntityList_function_type )( ::entity_list_ids_t ) ;
            
            C_FuncBrush_exposer.def( 
                "AddToEntityList"
                , AddToEntityList_function_type( &C_FuncBrush_wrapper::AddToEntityList )
                , ( bp::arg("listId") ) );
        ...
        { //::C_BaseEntity::ClientThink
            ...
            typedef void ( C_FuncBrush_wrapper::*default_ClientThink_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "ClientThink"
                , ClientThink_function_type(&::C_BaseEntity::ClientThink)
                , default_ClientThink_function_type(&C_FuncBrush_wrapper::default_ClientThink) );
        ...
        { //::C_BaseEntity::ComputeWorldSpaceSurroundingBox
            ...
            typedef void ( C_FuncBrush_wrapper::*default_ComputeWorldSpaceSurroundingBox_function_type )( ::Vector *,::Vector * ) ;
            
            C_FuncBrush_exposer.def( 
                "ComputeWorldSpaceSurroundingBox"
                , ComputeWorldSpaceSurroundingBox_function_type(&::C_BaseEntity::ComputeWorldSpaceSurroundingBox)
                , default_ComputeWorldSpaceSurroundingBox_function_type(&C_FuncBrush_wrapper::default_ComputeWorldSpaceSurroundingBox)
        ...
        { //::C_BaseEntity::CreateVPhysics
            ...
            typedef bool ( C_FuncBrush_wrapper::*default_CreateVPhysics_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "CreateVPhysics"
                , CreateVPhysics_function_type(&::C_BaseEntity::CreateVPhysics)
                , default_CreateVPhysics_function_type(&C_FuncBrush_wrapper::default_CreateVPhysics) );
        
        }
        { //::C_BaseEntity::DoImpactEffect
        
            typedef void ( ::C_BaseEntity::*DoImpactEffect_function_type )( ::trace_t &,int ) ;
            typedef void ( C_FuncBrush_wrapper::*default_DoImpactEffect_function_type )( ::trace_t &,int ) ;
            
            C_FuncBrush_exposer.def( 
                "DoImpactEffect"
                , DoImpactEffect_function_type(&::C_BaseEntity::DoImpactEffect)
                , default_DoImpactEffect_function_type(&C_FuncBrush_wrapper::default_DoImpactEffect)
        ...
        { //::C_BaseEntity::EndTouch
            ...
            typedef void ( C_FuncBrush_wrapper::*default_EndTouch_function_type )( ::C_BaseEntity * ) ;
            
            C_FuncBrush_exposer.def( 
                "EndTouch"
                , EndTouch_function_type(&::C_BaseEntity::EndTouch)
                , default_EndTouch_function_type(&C_FuncBrush_wrapper::default_EndTouch)
                , ( bp::arg("pOther") ) );
        ...
        { //::C_BaseEntity::GetCollideType
            ...
            typedef ::CollideType_t ( C_FuncBrush_wrapper::*default_GetCollideType_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "GetCollideType"
                , GetCollideType_function_type(&::C_BaseEntity::GetCollideType)
                , default_GetCollideType_function_type(&C_FuncBrush_wrapper::default_GetCollideType) );
        
        }
        { //::C_BaseEntity::GetIMouse
        
            typedef ::IMouse * ( ::C_BaseEntity::*GetIMouse_function_type )(  ) ;
            typedef ::IMouse * ( C_FuncBrush_wrapper::*default_GetIMouse_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "GetIMouse"
                , GetIMouse_function_type(&::C_BaseEntity::GetIMouse)
                , default_GetIMouse_function_type(&C_FuncBrush_wrapper::default_GetIMouse)
        ...
        { //::C_BaseEntity::GetTracerType
            ...
            typedef char const * ( C_FuncBrush_wrapper::*default_GetTracerType_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "GetTracerType"
                , GetTracerType_function_type(&::C_BaseEntity::GetTracerType)
                , default_GetTracerType_function_type(&C_FuncBrush_wrapper::default_GetTracerType) );
        
        }
        { //::C_BaseEntity::KeyValue
        
            typedef bool ( ::C_BaseEntity::*KeyValue_function_type )( char const *,char const * ) ;
            typedef bool ( C_FuncBrush_wrapper::*default_KeyValue_function_type )( char const *,char const * ) ;
            
            C_FuncBrush_exposer.def( 
                "KeyValue"
                , KeyValue_function_type(&::C_BaseEntity::KeyValue)
                , default_KeyValue_function_type(&C_FuncBrush_wrapper::default_KeyValue)
        ...
        { //::C_BaseEntity::KeyValue
            ...
            typedef bool ( C_FuncBrush_wrapper::*default_KeyValue_function_type )( char const *,float ) ;
        ...
        { //::C_BaseEntity::KeyValue
            ...
            typedef bool ( C_FuncBrush_wrapper::*default_KeyValue_function_type )( char const *,int ) ;
        ...
        { //::C_BaseEntity::KeyValue
            ...
            typedef bool ( C_FuncBrush_wrapper::*default_KeyValue_function_type )( char const *,::Vector const & ) ;
        ...
        { //::C_BaseEntity::MakeTracer
            ...
            typedef void ( C_FuncBrush_wrapper::*default_MakeTracer_function_type )( ::Vector const &,::trace_t const &,int ) ;
            
            C_FuncBrush_exposer.def( 
                "MakeTracer"
                , MakeTracer_function_type(&::C_BaseEntity::MakeTracer)
                , default_MakeTracer_function_type(&C_FuncBrush_wrapper::default_MakeTracer)
        ...
        { //::C_BaseEntity::OnChangeOwnerNumber
            ...
            typedef void ( C_FuncBrush_wrapper::*default_OnChangeOwnerNumber_function_type )( int ) ;
            
            C_FuncBrush_exposer.def( 
                "OnChangeOwnerNumber"
                , OnChangeOwnerNumber_function_type(&::C_BaseEntity::OnChangeOwnerNumber)
                , default_OnChangeOwnerNumber_function_type(&C_FuncBrush_wrapper::default_OnChangeOwnerNumber)
        ...
        { //::C_BaseEntity::OnRestore
            ...
            typedef void ( C_FuncBrush_wrapper::*default_OnRestore_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "OnRestore"
                , OnRestore_function_type(&::C_BaseEntity::OnRestore)
                , default_OnRestore_function_type(&C_FuncBrush_wrapper::default_OnRestore) );
        
        }
        { //::C_BaseEntity::Precache
        
            typedef void ( ::C_BaseEntity::*Precache_function_type )(  ) ;
            typedef void ( C_FuncBrush_wrapper::*default_Precache_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "Precache"
                , Precache_function_type(&::C_BaseEntity::Precache)
                , default_Precache_function_type(&C_FuncBrush_wrapper::default_Precache) );
        
        }
        { //::C_BaseEntity::PyNotifyShouldTransmit
        
            typedef void ( ::C_BaseEntity::*NotifyShouldTransmit_function_type )( ::ShouldTransmitState_t ) ;
            typedef void ( C_FuncBrush_wrapper::*default_NotifyShouldTransmit_function_type )( ::ShouldTransmitState_t ) ;
            
            C_FuncBrush_exposer.def( 
                "NotifyShouldTransmit"
                , NotifyShouldTransmit_function_type(&::C_BaseEntity::PyNotifyShouldTransmit)
                , default_NotifyShouldTransmit_function_type(&C_FuncBrush_wrapper::default_NotifyShouldTransmit)
                , ( bp::arg("state") ) );
        ...
        { //::C_BaseEntity::PyReceiveMessage
            ...
            typedef void ( C_FuncBrush_wrapper::*default_ReceiveMessage_function_type )( ::boost::python::list ) ;
            
            C_FuncBrush_exposer.def( 
                "ReceiveMessage"
                , ReceiveMessage_function_type(&::C_BaseEntity::PyReceiveMessage)
                , default_ReceiveMessage_function_type(&C_FuncBrush_wrapper::default_ReceiveMessage)
                , ( bp::arg("msg") ) );
        
        }
        { //::C_BaseEntity::RemoveFromEntityList
        
            typedef void ( C_FuncBrush_wrapper::*RemoveFromEntityList_function_type )( ::entity_list_ids_t ) ;
            
            C_FuncBrush_exposer.def( 
                "RemoveFromEntityList"
                , RemoveFromEntityList_function_type( &C_FuncBrush_wrapper::RemoveFromEntityList )
                , ( bp::arg("listId") ) );
        ...
        { //::C_BaseEntity::ShouldDraw
            ...
            typedef bool ( C_FuncBrush_wrapper::*default_ShouldDraw_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "ShouldDraw"
                , ShouldDraw_function_type(&::C_BaseEntity::ShouldDraw)
                , default_ShouldDraw_function_type(&C_FuncBrush_wrapper::default_ShouldDraw) );
        
        }
        { //::C_BaseEntity::Simulate
        
            typedef bool ( ::C_BaseEntity::*Simulate_function_type )(  ) ;
            typedef bool ( C_FuncBrush_wrapper::*default_Simulate_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "Simulate"
                , Simulate_function_type(&::C_BaseEntity::Simulate)
                , default_Simulate_function_type(&C_FuncBrush_wrapper::default_Simulate) );
        
        }
        { //::C_BaseEntity::Spawn
        
            typedef void ( ::C_BaseEntity::*Spawn_function_type )(  ) ;
            typedef void ( C_FuncBrush_wrapper::*default_Spawn_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "Spawn"
                , Spawn_function_type(&::C_BaseEntity::Spawn)
                , default_Spawn_function_type(&C_FuncBrush_wrapper::default_Spawn) );
        
        }
        { //::C_BaseEntity::StartTouch
        
            typedef void ( ::C_BaseEntity::*StartTouch_function_type )( ::C_BaseEntity * ) ;
            typedef void ( C_FuncBrush_wrapper::*default_StartTouch_function_type )( ::C_BaseEntity * ) ;
            
            C_FuncBrush_exposer.def( 
                "StartTouch"
                , StartTouch_function_type(&::C_BaseEntity::StartTouch)
                , default_StartTouch_function_type(&C_FuncBrush_wrapper::default_StartTouch)
                , ( bp::arg("pOther") ) );
        ...
        { //::C_BaseEntity::UpdateOnRemove
            ...
            typedef void ( C_FuncBrush_wrapper::*default_UpdateOnRemove_function_type )(  ) ;
            
            C_FuncBrush_exposer.def( 
                "UpdateOnRemove"
                , UpdateOnRemove_function_type(&::C_BaseEntity::UpdateOnRemove)
                , default_UpdateOnRemove_function_type(&C_FuncBrush_wrapper::default_UpdateOnRemove) );
        
        }
        { //::C_FuncBrush::TestCollision
            
                typedef bool ( ::C_FuncBrush::*TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;
                typedef bool ( C_FuncBrush_wrapper::*default_TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;

                C_FuncBrush_exposer.def( 
                    "TestCollision"
                    , TestCollision_function_type(&::C_FuncBrush::TestCollision)
                    , default_TestCollision_function_type(&C_FuncBrush_wrapper::default_TestCollision)
