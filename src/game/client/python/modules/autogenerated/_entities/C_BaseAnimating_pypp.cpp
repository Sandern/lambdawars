...
struct C_BaseAnimating_wrapper : C_BaseAnimating, bp::wrapper< C_BaseAnimating > {
    ...
    static int m_lifeState_Get( C_BaseAnimating const & inst ) { return inst.m_lifeState; }

    static void m_lifeState_Set( C_BaseAnimating & inst, int val ) { inst.m_lifeState = val; }

    static int m_takedamage_Get( C_BaseAnimating const & inst ) { return inst.m_takedamage; }
...
void register_C_BaseAnimating_class(){
    ...
    { //::C_BaseAnimating
        ...
        { //::C_BaseAnimating::PyPostOnNewModel
            ...
            typedef void ( C_BaseAnimating_wrapper::*default_PostOnNewModel_function_type )(  ) ;
            
            C_BaseAnimating_exposer.def( 
                "PostOnNewModel"
                , PostOnNewModel_function_type(&::C_BaseAnimating::PyPostOnNewModel)
                , default_PostOnNewModel_function_type(&C_BaseAnimating_wrapper::default_PostOnNewModel) );
        ...
        { //::C_BaseEntity::Restore
            ...
            typedef int ( C_BaseAnimating_wrapper::*default_Restore_function_type )( ::IRestore & ) ;
            
            C_BaseAnimating_exposer.def( 
                "Restore"
                , Restore_function_type(&::C_BaseEntity::Restore)
                , default_Restore_function_type(&C_BaseAnimating_wrapper::default_Restore)
                , ( bp::arg("restore") ) );
