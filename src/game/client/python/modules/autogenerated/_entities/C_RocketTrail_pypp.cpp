...
#include "C_RocketTrail_pypp.hpp"

namespace bp = boost::python;

struct C_RocketTrail_wrapper : C_RocketTrail, bp::wrapper< C_RocketTrail > {

    C_RocketTrail_wrapper( )
    : C_RocketTrail( )
      , bp::wrapper< C_RocketTrail >(){
        // null constructor
    ...
    virtual void OnDataChanged( ::DataUpdateType_t updateType ) {
        ...
        if( func_OnDataChanged.ptr() != Py_None )
            try {
                ...
                PyErr_Print();
                this->C_RocketTrail::OnDataChanged( updateType );
            }
        else
            this->C_RocketTrail::OnDataChanged( updateType );
    }
    ...
    void default_OnDataChanged( ::DataUpdateType_t updateType ) {
        C_RocketTrail::OnDataChanged( updateType );
    }
    ...
    static void m_lifeState_Set( C_RocketTrail & inst, int val ) { inst.m_lifeState = val; }

    static int m_takedamage_Get( C_RocketTrail const & inst ) { return inst.m_takedamage; }

    static void m_takedamage_Set( C_RocketTrail & inst, int val ) { inst.m_takedamage = val; }
...
void register_C_RocketTrail_class(){
    ...
    bp::class_< C_RocketTrail_wrapper, bp::bases< C_BaseParticleEntity >, boost::noncopyable >( "C_RocketTrail", bp::init< >() )    
        ...
        .def( 
            ...
            , (int ( C_RocketTrail_wrapper::* )( ::IRestore & ) )(&C_RocketTrail_wrapper::default_Restore)
            , ( bp::arg("restore") ) )    
        .def( 
            "ShouldDraw"
        ...
        .add_property( "lifestate", &C_RocketTrail_wrapper::m_lifeState_Get, &C_RocketTrail_wrapper::m_lifeState_Set )    
        .add_property( "takedamage", &C_RocketTrail_wrapper::m_takedamage_Get, &C_RocketTrail_wrapper::m_takedamage_Set );
