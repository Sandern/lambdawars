...
struct C_WarsWeapon_wrapper : C_WarsWeapon, bp::wrapper< C_WarsWeapon > {
    ...
    virtual ClientClass* GetClientClass() {
        PY_OVERRIDE_CHECK( C_WarsWeapon, GetClientClass )
...
void register_C_WarsWeapon_class(){
    ...
    { //::C_WarsWeapon
        ...
        { //::C_BaseEntity::Restore
            ...
            typedef int ( C_WarsWeapon_wrapper::*default_Restore_function_type )( ::IRestore & ) ;
            
            C_WarsWeapon_exposer.def( 
                "Restore"
                , Restore_function_type(&::C_BaseEntity::Restore)
                , default_Restore_function_type(&C_WarsWeapon_wrapper::default_Restore)
                , ( bp::arg("restore") ) );
