...
struct C_BaseTrigger_wrapper : C_BaseTrigger, bp::wrapper< C_BaseTrigger > {
    ...
    virtual ClientClass* GetClientClass() {
        PY_OVERRIDE_CHECK( C_BaseTrigger, GetClientClass )
    ...
    static int m_lifeState_Get( C_BaseTrigger const & inst ) { return inst.m_lifeState; }

    static void m_lifeState_Set( C_BaseTrigger & inst, int val ) { inst.m_lifeState = val; }

    static int m_takedamage_Get( C_BaseTrigger const & inst ) { return inst.m_takedamage; }

    static void m_takedamage_Set( C_BaseTrigger & inst, int val ) { inst.m_takedamage = val; }
...
void register_C_BaseTrigger_class(){
    ...
    bp::class_< C_BaseTrigger_wrapper, bp::bases< C_BaseToggle >, boost::noncopyable >( "C_BaseTrigger" )    
        ...
        .def( 
            ...
            , (void ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_Activate) )    
        .def( 
            "AddToEntityList"
            , (void ( C_BaseTrigger_wrapper::* )( ::entity_list_ids_t ) )(&C_BaseTrigger_wrapper::AddToEntityList)
            , ( bp::arg("listId") ) )    
        .def( 
            "ClientThink"
            , (void ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::ClientThink)
            , (void ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_ClientThink) )    
        .def( 
            "ComputeWorldSpaceSurroundingBox"
            , (void ( ::C_BaseEntity::* )( ::Vector *,::Vector * ) )(&::C_BaseEntity::ComputeWorldSpaceSurroundingBox)
            , (void ( C_BaseTrigger_wrapper::* )( ::Vector *,::Vector * ) )(&C_BaseTrigger_wrapper::default_ComputeWorldSpaceSurroundingBox)
            , ( bp::arg("pVecWorldMins"), bp::arg("pVecWorldMaxs") ) )    
        .def( 
            "CreateVPhysics"
            , (bool ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::CreateVPhysics)
            , (bool ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_CreateVPhysics) )    
        .def( 
            "DoImpactEffect"
            , (void ( ::C_BaseEntity::* )( ::trace_t &,int ) )(&::C_BaseEntity::DoImpactEffect)
            , (void ( C_BaseTrigger_wrapper::* )( ::trace_t &,int ) )(&C_BaseTrigger_wrapper::default_DoImpactEffect)
            , ( bp::arg("tr"), bp::arg("nDamageType") ) )    
        .def( 
            "EndTouch"
            , (void ( ::C_BaseEntity::* )( ::C_BaseEntity * ) )(&::C_BaseEntity::EndTouch)
            , (void ( C_BaseTrigger_wrapper::* )( ::C_BaseEntity * ) )(&C_BaseTrigger_wrapper::default_EndTouch)
            , ( bp::arg("pOther") ) )    
        .def( 
            "GetCollideType"
            , (::CollideType_t ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::GetCollideType)
            , (::CollideType_t ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_GetCollideType) )    
        .def( 
            "GetIMouse"
            , (::IMouse * ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::GetIMouse)
            , (::IMouse * ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_GetIMouse)
            , bp::return_value_policy< bp::return_by_value >() )    
        .def( 
            "GetTracerType"
            , (char const * ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::GetTracerType)
            , (char const * ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_GetTracerType) )    
        .def( 
            "KeyValue"
            , (bool ( ::C_BaseEntity::* )( char const *,char const * ) )(&::C_BaseEntity::KeyValue)
            , (bool ( C_BaseTrigger_wrapper::* )( char const *,char const * ) )(&C_BaseTrigger_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("szValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::C_BaseEntity::* )( char const *,float ) )(&::C_BaseEntity::KeyValue)
            , (bool ( C_BaseTrigger_wrapper::* )( char const *,float ) )(&C_BaseTrigger_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("flValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::C_BaseEntity::* )( char const *,int ) )(&::C_BaseEntity::KeyValue)
            , (bool ( C_BaseTrigger_wrapper::* )( char const *,int ) )(&C_BaseTrigger_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("nValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::C_BaseEntity::* )( char const *,::Vector const & ) )(&::C_BaseEntity::KeyValue)
            , (bool ( C_BaseTrigger_wrapper::* )( char const *,::Vector const & ) )(&C_BaseTrigger_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("vecValue") ) )    
        .def( 
            "MakeTracer"
            , (void ( ::C_BaseEntity::* )( ::Vector const &,::trace_t const &,int ) )(&::C_BaseEntity::MakeTracer)
            , (void ( C_BaseTrigger_wrapper::* )( ::Vector const &,::trace_t const &,int ) )(&C_BaseTrigger_wrapper::default_MakeTracer)
            , ( bp::arg("vecTracerSrc"), bp::arg("tr"), bp::arg("iTracerType") ) )    
        .def( 
            "NotifyShouldTransmit"
            , (void ( ::C_BaseEntity::* )( ::ShouldTransmitState_t ) )(&::C_BaseEntity::NotifyShouldTransmit)
            , (void ( C_BaseTrigger_wrapper::* )( ::ShouldTransmitState_t ) )(&C_BaseTrigger_wrapper::default_NotifyShouldTransmit)
            , ( bp::arg("state") ) )    
        .def( 
            "OnChangeOwnerNumber"
            , (void ( ::C_BaseEntity::* )( int ) )(&::C_BaseEntity::OnChangeOwnerNumber)
            , (void ( C_BaseTrigger_wrapper::* )( int ) )(&C_BaseTrigger_wrapper::default_OnChangeOwnerNumber)
            , ( bp::arg("old_owner_number") ) )    
        .def( 
            "OnDataChanged"
            , (void ( ::C_BaseEntity::* )( ::DataUpdateType_t ) )(&::C_BaseEntity::OnDataChanged)
            , (void ( C_BaseTrigger_wrapper::* )( ::DataUpdateType_t ) )(&C_BaseTrigger_wrapper::default_OnDataChanged)
            , ( bp::arg("type") ) )    
        .def( 
            "OnRestore"
            , (void ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::OnRestore)
            , (void ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_OnRestore) )    
        .def( 
            "Precache"
            , (void ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::Precache)
            , (void ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_Precache) )    
        .def( 
            "ReceiveMessage"
            , (void ( ::C_BaseEntity::* )( ::boost::python::list ) )(&::C_BaseEntity::PyReceiveMessage)
            , (void ( C_BaseTrigger_wrapper::* )( ::boost::python::list ) )(&C_BaseTrigger_wrapper::default_ReceiveMessage)
            , ( bp::arg("msg") ) )    
        .def( 
            "RemoveFromEntityList"
            , (void ( C_BaseTrigger_wrapper::* )( ::entity_list_ids_t ) )(&C_BaseTrigger_wrapper::RemoveFromEntityList)
            , ( bp::arg("listId") ) )    
        .def( 
            "Restore"
            , (int ( ::C_BaseEntity::* )( ::IRestore & ) )(&::C_BaseEntity::Restore)
            , (int ( C_BaseTrigger_wrapper::* )( ::IRestore & ) )(&C_BaseTrigger_wrapper::default_Restore)
            , ( bp::arg("restore") ) )    
        .def( 
            "ShouldDraw"
            , (bool ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::ShouldDraw)
            , (bool ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_ShouldDraw) )    
        .def( 
            "Simulate"
            , (bool ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::Simulate)
            , (bool ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_Simulate) )    
        .def( 
            "Spawn"
            , (void ( ::C_BaseEntity::* )(  ) )(&::C_BaseEntity::Spawn)
            , (void ( C_BaseTrigger_wrapper::* )(  ) )(&C_BaseTrigger_wrapper::default_Spawn) )    
        .def( 
            "StartTouch"
            , (void ( ::C_BaseEntity::* )( ::C_BaseEntity * ) )(&::C_BaseEntity::StartTouch)
            , (void ( C_BaseTrigger_wrapper::* )( ::C_BaseEntity * ) )(&C_BaseTrigger_wrapper::default_StartTouch)
            , ( bp::arg("pOther") ) )    
        .def( 
            "UpdateOnRemove"
