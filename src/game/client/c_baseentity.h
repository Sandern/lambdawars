...
public:
	...
	void	SetOverrideClassname( const char *classname );

	virtual IMouse *GetIMouse() { return NULL; }
	virtual IUnit *GetIUnit() { return NULL; }

	virtual bool IsUnit() { return false; }
	virtual C_UnitBase *MyUnitPointer( void ) { return NULL; }
	...
	void							SetOwnerNumber( int owner_number );
	...
	void							SetMousePassEntity( CBaseEntity *pEnt );

	int								CalculateOwnerCollisionGroup();
	int								CalculateIgnoreOwnerCollisionGroup();
	...
	void							PyUpdateNetworkVar( const char *pName, bp::object data );
...
// 
//-----------------------------------------------------------------------------
inline void	CBaseEntity::SetOverrideClassname( const char *classname )
{
	m_iszOverrideClassname = MAKE_STRING(classname); 
}

//-----------------------------------------------------------------------------
// 
//-----------------------------------------------------------------------------
inline int CBaseEntity::GetOwnerNumber( void )
{ 
	return m_iOwnerNumber; 
}

inline void CBaseEntity::SetMousePassEntity( CBaseEntity *pEnt )
{
	m_hMousePassEntity = pEnt;
}

inline CBaseEntity *CBaseEntity::GetMousePassEntity( )
{
...
// Purpose: 
//------------------------------------------------------------------------------
inline int CBaseEntity::CalculateOwnerCollisionGroup()
{
	return WARS_COLLISION_GROUP_UNIT_START + GetOwnerNumber();
}

inline int CBaseEntity::CalculateIgnoreOwnerCollisionGroup()
{
	return WARS_COLLISION_GROUP_IGNORE_UNIT_START + GetOwnerNumber();
}

//-----------------------------------------------------------------------------
// FOW related
//-----------------------------------------------------------------------------
inline int CBaseEntity::GetFOWFlags() 
{ 
	return m_nFOWFlags;
}
...
inline bool	CBaseEntity::IsInFOW() 
{ 
	return m_bInFOW; 
}

inline void	CBaseEntity::SetInFOW( bool infow )
{ 
	m_bInFOW = infow; 
}
