...
ConVar cl_detaildist( "cl_detaildist", "2000", 0, "Distance at which detail props are no longer visible", DetailFadeCallback );
ConVar cl_detailfade( "cl_detailfade", "1200", 0, "Distance across which detail props fade in", DetailFadeCallback );
...
#ifdef HL2WARS_DLL
	CUnitEnumerator avoid( flRadius, m_Origin );
#else
