...
#ifndef VGUI_ROOTPANEL_HL2Wars_H
#define VGUI_ROOTPANEL_HL2Wars_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class C_HL2WarsRootPanel : public vgui::Panel
{
	typedef vgui::Panel BaseClass;
public:
						C_HL2WarsRootPanel( vgui::VPANEL parent );
	virtual				~C_HL2WarsRootPanel( void );
...
#endif // VGUI_ROOTPANEL_HL2Wars_H
