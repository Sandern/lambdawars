//========= Copyright © 20xx, Sandern Corporation, All rights reserved. ============//
//
// Purpose: 
//
//=============================================================================//
...
public:
	...
	DECLARE_PYCLIENTCLASS( C_HL2WarsPlayer );
	...
	void							MinimapClick( Vector &vStart, Vector &vEnd, CBaseEntity *pHitEnt );
