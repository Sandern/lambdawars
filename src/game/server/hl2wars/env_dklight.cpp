...
//------------------------------------------------------------------------------
class CDKLight : public CBaseEntity
{
public:
	DECLARE_CLASS( CDKLight, CBaseEntity );
...
LINK_ENTITY_TO_CLASS(env_dk_light, CDKLight);

BEGIN_DATADESC( CDKLight )
...
IMPLEMENT_SERVERCLASS_ST_NOBASE(CDKLight, DT_DKLight)
...
//------------------------------------------------------------------------------
int CDKLight::UpdateTransmitState()
{
...
bool CDKLight::KeyValue( const char *szKeyName, const char *szValue )
{
...
bool CDKLight::GetKeyValue( const char *szKeyName, char *szValue, int iMaxLen )
{
	if ( FStrEq( szKeyName, "color" ) )
	{
...
// Input values
//------------------------------------------------------------------------------
void CDKLight::InputSetAngles( inputdata_t &inputdata )
{
...
//------------------------------------------------------------------------------
void CDKLight::InputEnable( inputdata_t &inputdata )
{
	m_bEnabled = true;
}

void CDKLight::InputDisable( inputdata_t &inputdata )
{
	m_bEnabled = false;
}

void CDKLight::InputSetTexture( inputdata_t &inputdata )
{
	Q_strcpy( m_TextureName.GetForModify(), inputdata.value.String() );
}

void CDKLight::InputSetEnableShadows( inputdata_t &inputdata )
{
	m_bEnableShadows = inputdata.value.Bool();
}

void CDKLight::InputSetLightColor( inputdata_t &inputdata )
{
