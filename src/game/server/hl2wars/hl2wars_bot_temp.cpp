...
class CSDKBot : public CHL2WarsPlayer
{
public:
	bool			m_bBackwards;
...
CBasePlayer *BotPutInServer( bool bFrozen )
{
	...
	// This trick lets us create a CSDKBot for this client instead of the CHL2WarsPlayer
...
// Output : 	virtual void
//-----------------------------------------------------------------------------
static void RunPlayerMove( CHL2WarsPlayer *fakeclient, CUserCmd &cmd, float frametime )
{
	if ( !fakeclient )
		return;
