...
struct CBaseAnimatingOverlay_wrapper : CBaseAnimatingOverlay, bp::wrapper< CBaseAnimatingOverlay > {
    ...
    virtual bool TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                ...
                #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
                if( py_log_overrides.GetBool() )
                    Msg("Calling TestCollision( boost::ref(ray), mask, boost::ref(trace) ) of Class: CBaseAnimatingOverlay\n");
                #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
                ...
                if( func_TestCollision.ptr() != Py_None )
                    try {
                        ...
                        PyErr_Print();
                        return this->CBaseAnimatingOverlay::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
                    }
                else
                    return this->CBaseAnimatingOverlay::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
            ...
            bool default_TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                return CBaseAnimatingOverlay::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
...
void register_CBaseAnimatingOverlay_class(){
    ...
    { //::CBaseAnimatingOverlay
        ...
        { //::CBaseAnimatingOverlay::TestCollision
            
                typedef bool ( ::CBaseAnimatingOverlay::*TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;
                typedef bool ( CBaseAnimatingOverlay_wrapper::*default_TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;

                CBaseAnimatingOverlay_exposer.def( 
                    "TestCollision"
                    , TestCollision_function_type(&::CBaseAnimatingOverlay::TestCollision)
                    , default_TestCollision_function_type(&CBaseAnimatingOverlay_wrapper::default_TestCollision)
