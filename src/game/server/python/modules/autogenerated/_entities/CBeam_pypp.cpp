...
struct CBeam_wrapper : CBeam, bp::wrapper< CBeam > {
    ...
    virtual bool TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                ...
                #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
                if( py_log_overrides.GetBool() )
                    Msg("Calling TestCollision( boost::ref(ray), mask, boost::ref(trace) ) of Class: CBeam\n");
                #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
                ...
                if( func_TestCollision.ptr() != Py_None )
                    try {
                        ...
                        PyErr_Print();
                        return this->CBeam::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
                    }
                else
                    return this->CBeam::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
            ...
            bool default_TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                return CBeam::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
...
void register_CBeam_class(){
    ...
    { //::CBeam
        ...
        { //::CBeam::TestCollision
                ...
                typedef bool ( ::CBeam::*TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;
                typedef bool ( CBeam_wrapper::*default_TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;

                CBeam_exposer.def( 
                    "TestCollision"
                    , TestCollision_function_type(&::CBeam::TestCollision)
                    , default_TestCollision_function_type(&CBeam_wrapper::default_TestCollision)
