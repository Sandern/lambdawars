...
struct CPlayerResource_wrapper : CPlayerResource, bp::wrapper< CPlayerResource > {
    ...
    virtual void Spawn(  ) {
        PY_OVERRIDE_CHECK( CPlayerResource, Spawn )
        PY_OVERRIDE_LOG( _entities, CPlayerResource, Spawn )
    ...
    virtual int UpdateTransmitState(  ) {
        PY_OVERRIDE_CHECK( CPlayerResource, UpdateTransmitState )
        PY_OVERRIDE_LOG( _entities, CPlayerResource, UpdateTransmitState )
    ...
    static int m_lifeState_Get( CPlayerResource const & inst ) { return inst.m_lifeState.Get(); }

    static void m_lifeState_Set( CPlayerResource & inst, int val ) { inst.m_lifeState.Set( val ); }

    static int m_takedamage_Get( CPlayerResource const & inst ) { return inst.m_takedamage.Get(); }

    static void m_takedamage_Set( CPlayerResource & inst, int val ) { inst.m_takedamage.Set( val ); }
