...
#include "SmokeTrail_pypp.hpp"

namespace bp = boost::python;

struct SmokeTrail_wrapper : SmokeTrail, bp::wrapper< SmokeTrail > {

    SmokeTrail_wrapper( )
    : SmokeTrail( )
      , bp::wrapper< SmokeTrail >(){
        // null constructor
    
    }

    virtual bool KeyValue( char const * szKeyName, char const * szValue ) {
        PY_OVERRIDE_CHECK( SmokeTrail, KeyValue )
        PY_OVERRIDE_LOG( _entities, SmokeTrail, KeyValue )
        ...
        if( func_KeyValue.ptr() != Py_None )
            try {
                ...
                PyErr_Print();
                return this->SmokeTrail::KeyValue( szKeyName, szValue );
            }
        else
            return this->SmokeTrail::KeyValue( szKeyName, szValue );
    }
    ...
    bool default_KeyValue( char const * szKeyName, char const * szValue ) {
        return SmokeTrail::KeyValue( szKeyName, szValue );
    }
    ...
    virtual ServerClass* GetServerClass() {
        PY_OVERRIDE_CHECK( SmokeTrail, GetServerClass )
        ...
        return SmokeTrail::GetServerClass();
    }

    static int m_lifeState_Get( SmokeTrail const & inst ) { return inst.m_lifeState.Get(); }

    static void m_lifeState_Set( SmokeTrail & inst, int val ) { inst.m_lifeState.Set( val ); }

    static int m_takedamage_Get( SmokeTrail const & inst ) { return inst.m_takedamage.Get(); }

    static void m_takedamage_Set( SmokeTrail & inst, int val ) { inst.m_takedamage.Set( val ); }
...
void register_SmokeTrail_class(){
    ...
    { //::SmokeTrail
        typedef bp::class_< SmokeTrail_wrapper, bp::bases< CBaseParticleEntity >, boost::noncopyable > SmokeTrail_exposer_t;
        SmokeTrail_exposer_t SmokeTrail_exposer = SmokeTrail_exposer_t( "SmokeTrail", bp::init< >() );
        bp::scope SmokeTrail_scope( SmokeTrail_exposer );
        { //::SmokeTrail::CreateSmokeTrail
        
            typedef ::SmokeTrail * ( *CreateSmokeTrail_function_type )(  );
            
            SmokeTrail_exposer.def( 
                "CreateSmokeTrail"
                , CreateSmokeTrail_function_type( &::SmokeTrail::CreateSmokeTrail )
                , bp::return_value_policy< bp::return_by_value >() );
        
        }
        { //::SmokeTrail::FollowEntity
        
            typedef void ( ::SmokeTrail::*FollowEntity_function_type )( ::CBaseEntity *,char const * ) ;
            
            SmokeTrail_exposer.def( 
                "FollowEntity"
                , FollowEntity_function_type( &::SmokeTrail::FollowEntity )
                , ( bp::arg("pEntity"), bp::arg("pAttachmentName")=bp::object() ) );
        
        }
        { //::SmokeTrail::KeyValue
        
            typedef bool ( ::SmokeTrail::*KeyValue_function_type )( char const *,char const * ) ;
            typedef bool ( SmokeTrail_wrapper::*default_KeyValue_function_type )( char const *,char const * ) ;
            
            SmokeTrail_exposer.def( 
                "KeyValue"
                , KeyValue_function_type(&::SmokeTrail::KeyValue)
                , default_KeyValue_function_type(&SmokeTrail_wrapper::default_KeyValue)
                , ( bp::arg("szKeyName"), bp::arg("szValue") ) );
        
        }
        { //::SmokeTrail::SetEmit
        
            typedef void ( ::SmokeTrail::*SetEmit_function_type )( bool ) ;
            
            SmokeTrail_exposer.def( 
                "SetEmit"
                , SetEmit_function_type( &::SmokeTrail::SetEmit )
                , ( bp::arg("bVal") ) );
        
        }
        SmokeTrail_exposer.def_readwrite( "endsize", &SmokeTrail::m_EndSize );
        SmokeTrail_exposer.def_readwrite( "maxdirectedspeed", &SmokeTrail::m_MaxDirectedSpeed );
        SmokeTrail_exposer.def_readwrite( "maxspeed", &SmokeTrail::m_MaxSpeed );
        SmokeTrail_exposer.def_readwrite( "mindirectedspeed", &SmokeTrail::m_MinDirectedSpeed );
        SmokeTrail_exposer.def_readwrite( "minspeed", &SmokeTrail::m_MinSpeed );
        SmokeTrail_exposer.def_readwrite( "opacity", &SmokeTrail::m_Opacity );
        SmokeTrail_exposer.def_readwrite( "particlelifetime", &SmokeTrail::m_ParticleLifetime );
        SmokeTrail_exposer.def_readwrite( "spawnradius", &SmokeTrail::m_SpawnRadius );
        SmokeTrail_exposer.def_readwrite( "spawnrate", &SmokeTrail::m_SpawnRate );
        SmokeTrail_exposer.def_readwrite( "startsize", &SmokeTrail::m_StartSize );
        SmokeTrail_exposer.def_readwrite( "stopemittime", &SmokeTrail::m_StopEmitTime );
        SmokeTrail_exposer.def_readwrite( "emit", &SmokeTrail::m_bEmit );
        SmokeTrail_exposer.def_readwrite( "attachment", &SmokeTrail::m_nAttachment );
        { //::CBaseParticleEntity::Activate
        
            typedef void ( ::CBaseParticleEntity::*Activate_function_type )(  ) ;
            typedef void ( SmokeTrail_wrapper::*default_Activate_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "Activate"
                , Activate_function_type(&::CBaseParticleEntity::Activate)
                , default_Activate_function_type(&SmokeTrail_wrapper::default_Activate) );
        ...
        { //::CBaseEntity::ComputeWorldSpaceSurroundingBox
            ...
            typedef void ( SmokeTrail_wrapper::*default_ComputeWorldSpaceSurroundingBox_function_type )( ::Vector *,::Vector * ) ;
            
            SmokeTrail_exposer.def( 
                "ComputeWorldSpaceSurroundingBox"
                , ComputeWorldSpaceSurroundingBox_function_type(&::CBaseEntity::ComputeWorldSpaceSurroundingBox)
                , default_ComputeWorldSpaceSurroundingBox_function_type(&SmokeTrail_wrapper::default_ComputeWorldSpaceSurroundingBox)
        ...
        { //::CBaseEntity::CreateVPhysics
            ...
            typedef bool ( SmokeTrail_wrapper::*default_CreateVPhysics_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "CreateVPhysics"
                , CreateVPhysics_function_type(&::CBaseEntity::CreateVPhysics)
                , default_CreateVPhysics_function_type(&SmokeTrail_wrapper::default_CreateVPhysics) );
        
        }
        { //::CBaseEntity::DeathNotice
        
            typedef void ( ::CBaseEntity::*DeathNotice_function_type )( ::CBaseEntity * ) ;
            typedef void ( SmokeTrail_wrapper::*default_DeathNotice_function_type )( ::CBaseEntity * ) ;
            
            SmokeTrail_exposer.def( 
                "DeathNotice"
                , DeathNotice_function_type(&::CBaseEntity::DeathNotice)
                , default_DeathNotice_function_type(&SmokeTrail_wrapper::default_DeathNotice)
                , ( bp::arg("pVictim") ) );
        ...
        { //::CBaseEntity::DoImpactEffect
            ...
            typedef void ( SmokeTrail_wrapper::*default_DoImpactEffect_function_type )( ::trace_t &,int ) ;
            
            SmokeTrail_exposer.def( 
                "DoImpactEffect"
                , DoImpactEffect_function_type(&::CBaseEntity::DoImpactEffect)
                , default_DoImpactEffect_function_type(&SmokeTrail_wrapper::default_DoImpactEffect)
        ...
        { //::CBaseEntity::DrawDebugGeometryOverlays
            ...
            typedef void ( SmokeTrail_wrapper::*default_DrawDebugGeometryOverlays_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "DrawDebugGeometryOverlays"
                , DrawDebugGeometryOverlays_function_type(&::CBaseEntity::DrawDebugGeometryOverlays)
                , default_DrawDebugGeometryOverlays_function_type(&SmokeTrail_wrapper::default_DrawDebugGeometryOverlays) );
        
        }
        { //::CBaseEntity::DrawDebugTextOverlays
        
            typedef int ( ::CBaseEntity::*DrawDebugTextOverlays_function_type )(  ) ;
            typedef int ( SmokeTrail_wrapper::*default_DrawDebugTextOverlays_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "DrawDebugTextOverlays"
                , DrawDebugTextOverlays_function_type(&::CBaseEntity::DrawDebugTextOverlays)
                , default_DrawDebugTextOverlays_function_type(&SmokeTrail_wrapper::default_DrawDebugTextOverlays) );
        
        }
        { //::CBaseEntity::EndTouch
        
            typedef void ( ::CBaseEntity::*EndTouch_function_type )( ::CBaseEntity * ) ;
            typedef void ( SmokeTrail_wrapper::*default_EndTouch_function_type )( ::CBaseEntity * ) ;
            
            SmokeTrail_exposer.def( 
                "EndTouch"
                , EndTouch_function_type(&::CBaseEntity::EndTouch)
                , default_EndTouch_function_type(&SmokeTrail_wrapper::default_EndTouch)
                , ( bp::arg("pOther") ) );
        ...
        { //::CBaseEntity::Event_Killed
            ...
            typedef void ( SmokeTrail_wrapper::*default_Event_Killed_function_type )( ::CTakeDamageInfo const & ) ;
            
            SmokeTrail_exposer.def( 
                "Event_Killed"
                , Event_Killed_function_type(&::CBaseEntity::Event_Killed)
                , default_Event_Killed_function_type(&SmokeTrail_wrapper::default_Event_Killed)
                , ( bp::arg("info") ) );
        ...
        { //::CBaseEntity::Event_KilledOther
            ...
            typedef void ( SmokeTrail_wrapper::*default_Event_KilledOther_function_type )( ::CBaseEntity *,::CTakeDamageInfo const & ) ;
            
            SmokeTrail_exposer.def( 
                "Event_KilledOther"
                , Event_KilledOther_function_type(&::CBaseEntity::Event_KilledOther)
                , default_Event_KilledOther_function_type(&SmokeTrail_wrapper::default_Event_KilledOther)
        ...
        { //::CBaseEntity::GetIMouse
            ...
            typedef ::IMouse * ( SmokeTrail_wrapper::*default_GetIMouse_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "GetIMouse"
                , GetIMouse_function_type(&::CBaseEntity::GetIMouse)
                , default_GetIMouse_function_type(&SmokeTrail_wrapper::default_GetIMouse)
                , bp::return_value_policy< bp::return_by_value >() );
        ...
        { //::CBaseEntity::GetTracerType
            ...
            typedef char const * ( SmokeTrail_wrapper::*default_GetTracerType_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "GetTracerType"
                , GetTracerType_function_type(&::CBaseEntity::GetTracerType)
                , default_GetTracerType_function_type(&SmokeTrail_wrapper::default_GetTracerType) );
        
        }
        { //::CBaseEntity::KeyValue
        
            typedef bool ( ::CBaseEntity::*KeyValue_function_type )( char const *,float ) ;
            typedef bool ( SmokeTrail_wrapper::*default_KeyValue_function_type )( char const *,float ) ;
        ...
        { //::CBaseEntity::KeyValue
            ...
            typedef bool ( SmokeTrail_wrapper::*default_KeyValue_function_type )( char const *,int ) ;
        ...
        { //::CBaseEntity::KeyValue
            ...
            typedef bool ( SmokeTrail_wrapper::*default_KeyValue_function_type )( char const *,::Vector const & ) ;
        ...
        { //::CBaseEntity::MakeTracer
            ...
            typedef void ( SmokeTrail_wrapper::*default_MakeTracer_function_type )( ::Vector const &,::trace_t const &,int ) ;
            
            SmokeTrail_exposer.def( 
                "MakeTracer"
                , MakeTracer_function_type(&::CBaseEntity::MakeTracer)
                , default_MakeTracer_function_type(&SmokeTrail_wrapper::default_MakeTracer)
        ...
        { //::CBaseEntity::ModifyOrAppendCriteria
            ...
            typedef void ( SmokeTrail_wrapper::*default_ModifyOrAppendCriteria_function_type )( ::ResponseRules::CriteriaSet & ) ;
            
            SmokeTrail_exposer.def( 
                "ModifyOrAppendCriteria"
                , ModifyOrAppendCriteria_function_type(&::CBaseEntity::ModifyOrAppendCriteria)
                , default_ModifyOrAppendCriteria_function_type(&SmokeTrail_wrapper::default_ModifyOrAppendCriteria)
                , ( bp::arg("set") ) );
        ...
        { //::CBaseEntity::OnChangeOwnerNumber
            ...
            typedef void ( SmokeTrail_wrapper::*default_OnChangeOwnerNumber_function_type )( int ) ;
            
            SmokeTrail_exposer.def( 
                "OnChangeOwnerNumber"
                , OnChangeOwnerNumber_function_type(&::CBaseEntity::OnChangeOwnerNumber)
                , default_OnChangeOwnerNumber_function_type(&SmokeTrail_wrapper::default_OnChangeOwnerNumber)
        ...
        { //::CBaseEntity::OnRestore
            ...
            typedef void ( SmokeTrail_wrapper::*default_OnRestore_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "OnRestore"
                , OnRestore_function_type(&::CBaseEntity::OnRestore)
                , default_OnRestore_function_type(&SmokeTrail_wrapper::default_OnRestore) );
        
        }
        { //::CBaseEntity::OnTakeDamage
        
            typedef int ( ::CBaseEntity::*OnTakeDamage_function_type )( ::CTakeDamageInfo const & ) ;
            typedef int ( SmokeTrail_wrapper::*default_OnTakeDamage_function_type )( ::CTakeDamageInfo const & ) ;
            
            SmokeTrail_exposer.def( 
                "OnTakeDamage"
                , OnTakeDamage_function_type(&::CBaseEntity::OnTakeDamage)
                , default_OnTakeDamage_function_type(&SmokeTrail_wrapper::default_OnTakeDamage)
                , ( bp::arg("info") ) );
        ...
        { //::CBaseEntity::PassesDamageFilter
            ...
            typedef bool ( SmokeTrail_wrapper::*default_PassesDamageFilter_function_type )( ::CTakeDamageInfo const & ) ;
            
            SmokeTrail_exposer.def( 
                "PassesDamageFilter"
                , PassesDamageFilter_function_type(&::CBaseEntity::PassesDamageFilter)
                , default_PassesDamageFilter_function_type(&SmokeTrail_wrapper::default_PassesDamageFilter)
                , ( bp::arg("info") ) );
        ...
        { //::CBaseEntity::PostClientActive
            ...
            typedef void ( SmokeTrail_wrapper::*default_PostClientActive_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "PostClientActive"
                , PostClientActive_function_type(&::CBaseEntity::PostClientActive)
                , default_PostClientActive_function_type(&SmokeTrail_wrapper::default_PostClientActive) );
        
        }
        { //::CBaseEntity::PostConstructor
        
            typedef void ( ::CBaseEntity::*PostConstructor_function_type )( char const * ) ;
            typedef void ( SmokeTrail_wrapper::*default_PostConstructor_function_type )( char const * ) ;
            
            SmokeTrail_exposer.def( 
                "PostConstructor"
                , PostConstructor_function_type(&::CBaseEntity::PostConstructor)
                , default_PostConstructor_function_type(&SmokeTrail_wrapper::default_PostConstructor)
                , ( bp::arg("szClassname") ) );
        ...
        { //::CBaseEntity::Precache
            ...
            typedef void ( SmokeTrail_wrapper::*default_Precache_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "Precache"
                , Precache_function_type(&::CBaseEntity::Precache)
                , default_Precache_function_type(&SmokeTrail_wrapper::default_Precache) );
        
        }
        { //::CBaseEntity::Restore
        
            typedef int ( ::CBaseEntity::*Restore_function_type )( ::IRestore & ) ;
            typedef int ( SmokeTrail_wrapper::*default_Restore_function_type )( ::IRestore & ) ;
            
            SmokeTrail_exposer.def( 
                "Restore"
                , Restore_function_type(&::CBaseEntity::Restore)
                , default_Restore_function_type(&SmokeTrail_wrapper::default_Restore)
                , ( bp::arg("restore") ) );
        ...
        { //::CBaseEntity::Spawn
            ...
            typedef void ( SmokeTrail_wrapper::*default_Spawn_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "Spawn"
                , Spawn_function_type(&::CBaseEntity::Spawn)
                , default_Spawn_function_type(&SmokeTrail_wrapper::default_Spawn) );
        
        }
        { //::CBaseEntity::StartTouch
        
            typedef void ( ::CBaseEntity::*StartTouch_function_type )( ::CBaseEntity * ) ;
            typedef void ( SmokeTrail_wrapper::*default_StartTouch_function_type )( ::CBaseEntity * ) ;
            
            SmokeTrail_exposer.def( 
                "StartTouch"
                , StartTouch_function_type(&::CBaseEntity::StartTouch)
                , default_StartTouch_function_type(&SmokeTrail_wrapper::default_StartTouch)
                , ( bp::arg("pOther") ) );
        ...
        { //::CBaseEntity::StopLoopingSounds
            ...
            typedef void ( SmokeTrail_wrapper::*default_StopLoopingSounds_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "StopLoopingSounds"
                , StopLoopingSounds_function_type(&::CBaseEntity::StopLoopingSounds)
                , default_StopLoopingSounds_function_type(&SmokeTrail_wrapper::default_StopLoopingSounds) );
        
        }
        { //::CBaseEntity::TraceAttack
        
            typedef void ( SmokeTrail_wrapper::*TraceAttack_function_type )( ::CTakeDamageInfo const &,::Vector const &,::trace_t * ) ;
            
            SmokeTrail_exposer.def( 
                "TraceAttack"
                , TraceAttack_function_type( &SmokeTrail_wrapper::TraceAttack )
        ...
        { //::CBaseEntity::UpdateOnRemove
            ...
            typedef void ( SmokeTrail_wrapper::*default_UpdateOnRemove_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "UpdateOnRemove"
                , UpdateOnRemove_function_type(&::CBaseEntity::UpdateOnRemove)
                , default_UpdateOnRemove_function_type(&SmokeTrail_wrapper::default_UpdateOnRemove) );
        
        }
        { //::CBaseParticleEntity::UpdateTransmitState
        
            typedef int ( ::CBaseParticleEntity::*UpdateTransmitState_function_type )(  ) ;
            typedef int ( SmokeTrail_wrapper::*default_UpdateTransmitState_function_type )(  ) ;
            
            SmokeTrail_exposer.def( 
                "UpdateTransmitState"
                , UpdateTransmitState_function_type(&::CBaseParticleEntity::UpdateTransmitState)
                , default_UpdateTransmitState_function_type(&SmokeTrail_wrapper::default_UpdateTransmitState) );
        
        }
        { //::CBaseEntity::VPhysicsCollision
        
            typedef void ( ::CBaseEntity::*VPhysicsCollision_function_type )( int,::gamevcollisionevent_t * ) ;
            typedef void ( SmokeTrail_wrapper::*default_VPhysicsCollision_function_type )( int,::gamevcollisionevent_t * ) ;
            
            SmokeTrail_exposer.def( 
                "VPhysicsCollision"
                , VPhysicsCollision_function_type(&::CBaseEntity::VPhysicsCollision)
                , default_VPhysicsCollision_function_type(&SmokeTrail_wrapper::default_VPhysicsCollision)
