...
#include "SporeExplosion_pypp.hpp"

namespace bp = boost::python;

struct SporeExplosion_wrapper : SporeExplosion, bp::wrapper< SporeExplosion > {

    SporeExplosion_wrapper( )
    : SporeExplosion( )
      , bp::wrapper< SporeExplosion >(){
        // null constructor
    
    }

    virtual void Spawn(  ) {
        PY_OVERRIDE_CHECK( SporeExplosion, Spawn )
        PY_OVERRIDE_LOG( _entities, SporeExplosion, Spawn )
    ...
    static void m_lifeState_Set( SporeExplosion & inst, int val ) { inst.m_lifeState.Set( val ); }

    static int m_takedamage_Get( SporeExplosion const & inst ) { return inst.m_takedamage.Get(); }

    static void m_takedamage_Set( SporeExplosion & inst, int val ) { inst.m_takedamage.Set( val ); }

};

void register_SporeExplosion_class(){

    bp::class_< SporeExplosion_wrapper, bp::bases< CBaseParticleEntity >, boost::noncopyable >( "SporeExplosion", bp::init< >() )    
        .def( 
            "CreateSporeExplosion"
            , (::SporeExplosion * (*)(  ))( &::SporeExplosion::CreateSporeExplosion )
            , bp::return_value_policy< bp::return_by_value >() )    
        .def( 
            "InputDisable"
            , (void ( ::SporeExplosion::* )( ::inputdata_t & ) )( &::SporeExplosion::InputDisable )
            , ( bp::arg("inputdata") ) )    
        .def( 
            "InputEnable"
            , (void ( ::SporeExplosion::* )( ::inputdata_t & ) )( &::SporeExplosion::InputEnable )
            , ( bp::arg("inputdata") ) )    
        .def( 
            "Spawn"
            , (void ( ::SporeExplosion::* )(  ) )(&::SporeExplosion::Spawn)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_Spawn) )    
        .def_readwrite( "disabled", &SporeExplosion::m_bDisabled )    
        .def_readwrite( "emit", &SporeExplosion::m_bEmit )    
        .def_readwrite( "endsize", &SporeExplosion::m_flEndSize )    
        .def_readwrite( "particlelifetime", &SporeExplosion::m_flParticleLifetime )    
        .def_readwrite( "spawnradius", &SporeExplosion::m_flSpawnRadius )    
        .def_readwrite( "spawnrate", &SporeExplosion::m_flSpawnRate )    
        .def_readwrite( "startsize", &SporeExplosion::m_flStartSize )    
        .def( 
            "Activate"
            , (void ( ::CBaseParticleEntity::* )(  ) )(&::CBaseParticleEntity::Activate)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_Activate) )    
        .def( 
            "ComputeWorldSpaceSurroundingBox"
            , (void ( ::CBaseEntity::* )( ::Vector *,::Vector * ) )(&::CBaseEntity::ComputeWorldSpaceSurroundingBox)
            , (void ( SporeExplosion_wrapper::* )( ::Vector *,::Vector * ) )(&SporeExplosion_wrapper::default_ComputeWorldSpaceSurroundingBox)
            , ( bp::arg("pWorldMins"), bp::arg("pWorldMaxs") ) )    
        .def( 
            "CreateVPhysics"
            , (bool ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::CreateVPhysics)
            , (bool ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_CreateVPhysics) )    
        .def( 
            "DeathNotice"
            , (void ( ::CBaseEntity::* )( ::CBaseEntity * ) )(&::CBaseEntity::DeathNotice)
            , (void ( SporeExplosion_wrapper::* )( ::CBaseEntity * ) )(&SporeExplosion_wrapper::default_DeathNotice)
            , ( bp::arg("pVictim") ) )    
        .def( 
            "DoImpactEffect"
            , (void ( ::CBaseEntity::* )( ::trace_t &,int ) )(&::CBaseEntity::DoImpactEffect)
            , (void ( SporeExplosion_wrapper::* )( ::trace_t &,int ) )(&SporeExplosion_wrapper::default_DoImpactEffect)
            , ( bp::arg("tr"), bp::arg("nDamageType") ) )    
        .def( 
            "DrawDebugGeometryOverlays"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::DrawDebugGeometryOverlays)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_DrawDebugGeometryOverlays) )    
        .def( 
            "DrawDebugTextOverlays"
            , (int ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::DrawDebugTextOverlays)
            , (int ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_DrawDebugTextOverlays) )    
        .def( 
            "EndTouch"
            , (void ( ::CBaseEntity::* )( ::CBaseEntity * ) )(&::CBaseEntity::EndTouch)
            , (void ( SporeExplosion_wrapper::* )( ::CBaseEntity * ) )(&SporeExplosion_wrapper::default_EndTouch)
            , ( bp::arg("pOther") ) )    
        .def( 
            "Event_Killed"
            , (void ( ::CBaseEntity::* )( ::CTakeDamageInfo const & ) )(&::CBaseEntity::Event_Killed)
            , (void ( SporeExplosion_wrapper::* )( ::CTakeDamageInfo const & ) )(&SporeExplosion_wrapper::default_Event_Killed)
            , ( bp::arg("info") ) )    
        .def( 
            "Event_KilledOther"
            , (void ( ::CBaseEntity::* )( ::CBaseEntity *,::CTakeDamageInfo const & ) )(&::CBaseEntity::Event_KilledOther)
            , (void ( SporeExplosion_wrapper::* )( ::CBaseEntity *,::CTakeDamageInfo const & ) )(&SporeExplosion_wrapper::default_Event_KilledOther)
            , ( bp::arg("pVictim"), bp::arg("info") ) )    
        .def( 
            "GetIMouse"
            , (::IMouse * ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::GetIMouse)
            , (::IMouse * ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_GetIMouse)
            , bp::return_value_policy< bp::return_by_value >() )    
        .def( 
            "GetTracerType"
            , (char const * ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::GetTracerType)
            , (char const * ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_GetTracerType) )    
        .def( 
            "KeyValue"
            , (bool ( ::CBaseEntity::* )( char const *,char const * ) )(&::CBaseEntity::KeyValue)
            , (bool ( SporeExplosion_wrapper::* )( char const *,char const * ) )(&SporeExplosion_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("szValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::CBaseEntity::* )( char const *,float ) )(&::CBaseEntity::KeyValue)
            , (bool ( SporeExplosion_wrapper::* )( char const *,float ) )(&SporeExplosion_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("flValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::CBaseEntity::* )( char const *,int ) )(&::CBaseEntity::KeyValue)
            , (bool ( SporeExplosion_wrapper::* )( char const *,int ) )(&SporeExplosion_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("nValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::CBaseEntity::* )( char const *,::Vector const & ) )(&::CBaseEntity::KeyValue)
            , (bool ( SporeExplosion_wrapper::* )( char const *,::Vector const & ) )(&SporeExplosion_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("vecValue") ) )    
        .def( 
            "MakeTracer"
            , (void ( ::CBaseEntity::* )( ::Vector const &,::trace_t const &,int ) )(&::CBaseEntity::MakeTracer)
            , (void ( SporeExplosion_wrapper::* )( ::Vector const &,::trace_t const &,int ) )(&SporeExplosion_wrapper::default_MakeTracer)
            , ( bp::arg("vecTracerSrc"), bp::arg("tr"), bp::arg("iTracerType") ) )    
        .def( 
            "ModifyOrAppendCriteria"
            , (void ( ::CBaseEntity::* )( ::ResponseRules::CriteriaSet & ) )(&::CBaseEntity::ModifyOrAppendCriteria)
            , (void ( SporeExplosion_wrapper::* )( ::ResponseRules::CriteriaSet & ) )(&SporeExplosion_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnChangeOwnerNumber"
            , (void ( ::CBaseEntity::* )( int ) )(&::CBaseEntity::OnChangeOwnerNumber)
            , (void ( SporeExplosion_wrapper::* )( int ) )(&SporeExplosion_wrapper::default_OnChangeOwnerNumber)
            , ( bp::arg("old_owner_number") ) )    
        .def( 
            "OnRestore"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::OnRestore)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_OnRestore) )    
        .def( 
            "OnTakeDamage"
            , (int ( ::CBaseEntity::* )( ::CTakeDamageInfo const & ) )(&::CBaseEntity::OnTakeDamage)
            , (int ( SporeExplosion_wrapper::* )( ::CTakeDamageInfo const & ) )(&SporeExplosion_wrapper::default_OnTakeDamage)
            , ( bp::arg("info") ) )    
        .def( 
            "PassesDamageFilter"
            , (bool ( ::CBaseEntity::* )( ::CTakeDamageInfo const & ) )(&::CBaseEntity::PassesDamageFilter)
            , (bool ( SporeExplosion_wrapper::* )( ::CTakeDamageInfo const & ) )(&SporeExplosion_wrapper::default_PassesDamageFilter)
            , ( bp::arg("info") ) )    
        .def( 
            "PostClientActive"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::PostClientActive)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_PostClientActive) )    
        .def( 
            "PostConstructor"
            , (void ( ::CBaseEntity::* )( char const * ) )(&::CBaseEntity::PostConstructor)
            , (void ( SporeExplosion_wrapper::* )( char const * ) )(&SporeExplosion_wrapper::default_PostConstructor)
            , ( bp::arg("szClassname") ) )    
        .def( 
            "Precache"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::Precache)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_Precache) )    
        .def( 
            "Restore"
            , (int ( ::CBaseEntity::* )( ::IRestore & ) )(&::CBaseEntity::Restore)
            , (int ( SporeExplosion_wrapper::* )( ::IRestore & ) )(&SporeExplosion_wrapper::default_Restore)
            , ( bp::arg("restore") ) )    
        .def( 
            "StartTouch"
            , (void ( ::CBaseEntity::* )( ::CBaseEntity * ) )(&::CBaseEntity::StartTouch)
            , (void ( SporeExplosion_wrapper::* )( ::CBaseEntity * ) )(&SporeExplosion_wrapper::default_StartTouch)
            , ( bp::arg("pOther") ) )    
        .def( 
            "StopLoopingSounds"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::StopLoopingSounds)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_StopLoopingSounds) )    
        .def( 
            "TraceAttack"
            , (void ( SporeExplosion_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t * ) )(&SporeExplosion_wrapper::TraceAttack)
            , ( bp::arg("info"), bp::arg("vecDir"), bp::arg("ptr") ) )    
        .def( 
            "UpdateOnRemove"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::UpdateOnRemove)
            , (void ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_UpdateOnRemove) )    
        .def( 
            "UpdateTransmitState"
            , (int ( ::CBaseParticleEntity::* )(  ) )(&::CBaseParticleEntity::UpdateTransmitState)
            , (int ( SporeExplosion_wrapper::* )(  ) )(&SporeExplosion_wrapper::default_UpdateTransmitState) )    
        .def( 
            "VPhysicsCollision"
            , (void ( ::CBaseEntity::* )( int,::gamevcollisionevent_t * ) )(&::CBaseEntity::VPhysicsCollision)
            , (void ( SporeExplosion_wrapper::* )( int,::gamevcollisionevent_t * ) )(&SporeExplosion_wrapper::default_VPhysicsCollision)
            , ( bp::arg("index"), bp::arg("pEvent") ) )    
        .staticmethod( "CreateSporeExplosion" )    
        .add_property( "lifestate", &SporeExplosion_wrapper::m_lifeState_Get, &SporeExplosion_wrapper::m_lifeState_Set )    
        .add_property( "takedamage", &SporeExplosion_wrapper::m_takedamage_Get, &SporeExplosion_wrapper::m_takedamage_Set );
