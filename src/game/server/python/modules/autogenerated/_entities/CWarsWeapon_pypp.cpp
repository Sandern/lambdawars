...
struct CWarsWeapon_wrapper : CWarsWeapon, bp::wrapper< CWarsWeapon > {
    ...
    virtual bool TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                ...
                #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
                if( py_log_overrides.GetBool() )
                    Msg("Calling TestCollision( boost::ref(ray), mask, boost::ref(trace) ) of Class: CWarsWeapon\n");
                #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
                ...
                if( func_TestCollision.ptr() != Py_None )
                    try {
                        ...
                        PyErr_Print();
                        return this->CWarsWeapon::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
                    }
                else
                    return this->CWarsWeapon::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
            ...
            bool default_TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                return CWarsWeapon::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
...
void register_CWarsWeapon_class(){
    ...
    { //::CWarsWeapon
        ...
        { //::CWarsWeapon::TestCollision
            
                typedef bool ( ::CWarsWeapon::*TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;
                typedef bool ( CWarsWeapon_wrapper::*default_TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;

                CWarsWeapon_exposer.def( 
                    "TestCollision"
                    , TestCollision_function_type(&::CWarsWeapon::TestCollision)
                    , default_TestCollision_function_type(&CWarsWeapon_wrapper::default_TestCollision)
                    , ( bp::arg("ray"), bp::arg("mask"), bp::arg("trace") ) );

            }
        CWarsWeapon_exposer.add_property("nextprimaryattack", 
           &CWarsWeapon_wrapper::m_flNextPrimaryAttack_Get,
           &CWarsWeapon_wrapper::m_flNextPrimaryAttack_Set );
        CWarsWeapon_exposer.add_property("nextsecondaryattack", 
           &CWarsWeapon_wrapper::m_flNextSecondaryAttack_Get,
           &CWarsWeapon_wrapper::m_flNextSecondaryAttack_Set );
        CWarsWeapon_exposer.add_property("timeweaponidle", 
           &CWarsWeapon_wrapper::m_flTimeWeaponIdle_Get,
           &CWarsWeapon_wrapper::m_flTimeWeaponIdle_Set );
        CWarsWeapon_exposer.add_property("state", 
           &CWarsWeapon_wrapper::m_iState_Get,
           &CWarsWeapon_wrapper::m_iState_Set );
        CWarsWeapon_exposer.add_property("primaryammotype", 
           &CWarsWeapon_wrapper::m_iPrimaryAmmoType_Get,
           &CWarsWeapon_wrapper::m_iPrimaryAmmoType_Set );
        CWarsWeapon_exposer.add_property("secondaryammotype", 
           &CWarsWeapon_wrapper::m_iSecondaryAmmoType_Get,
           &CWarsWeapon_wrapper::m_iSecondaryAmmoType_Set );
        CWarsWeapon_exposer.add_property("clip1", 
           &CWarsWeapon_wrapper::m_iClip1_Get,
           &CWarsWeapon_wrapper::m_iClip1_Set );
        CWarsWeapon_exposer.add_property("clip2", 
           &CWarsWeapon_wrapper::m_iClip2_Get,
           &CWarsWeapon_wrapper::m_iClip2_Set );
    }
