...
struct IServerUnknown_wrapper : IServerUnknown, bp::wrapper< IServerUnknown > {

    IServerUnknown_wrapper()
    : IServerUnknown()
      , bp::wrapper< IServerUnknown >(){
        // null constructor
...
void register_IServerUnknown_class(){
    ...
    bp::class_< IServerUnknown_wrapper, boost::noncopyable >( "IServerUnknown", bp::no_init )    
        .def( 
            "GetRefEHandle"
