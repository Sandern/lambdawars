...
struct CLogicalEntity_wrapper : CLogicalEntity, bp::wrapper< CLogicalEntity > {
    ...
    static int m_lifeState_Get( CLogicalEntity const & inst ) { return inst.m_lifeState.Get(); }

    static void m_lifeState_Set( CLogicalEntity & inst, int val ) { inst.m_lifeState.Set( val ); }

    static int m_takedamage_Get( CLogicalEntity const & inst ) { return inst.m_takedamage.Get(); }

    static void m_takedamage_Set( CLogicalEntity & inst, int val ) { inst.m_takedamage.Set( val ); }
...
void register_CLogicalEntity_class(){
    ...
    bp::class_< CLogicalEntity_wrapper, bp::bases< CServerOnlyEntity >, boost::noncopyable >( "CLogicalEntity" )    
        .def( 
            ...
            , (bool ( CLogicalEntity_wrapper::* )( char const *,char const * ) )(&CLogicalEntity_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("szValue") ) )    
        .def( 
            "Activate"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::Activate)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_Activate) )    
        .def( 
            "ComputeWorldSpaceSurroundingBox"
            , (void ( ::CBaseEntity::* )( ::Vector *,::Vector * ) )(&::CBaseEntity::ComputeWorldSpaceSurroundingBox)
            , (void ( CLogicalEntity_wrapper::* )( ::Vector *,::Vector * ) )(&CLogicalEntity_wrapper::default_ComputeWorldSpaceSurroundingBox)
            , ( bp::arg("pWorldMins"), bp::arg("pWorldMaxs") ) )    
        .def( 
            "CreateVPhysics"
            , (bool ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::CreateVPhysics)
            , (bool ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_CreateVPhysics) )    
        .def( 
            "DeathNotice"
            , (void ( ::CBaseEntity::* )( ::CBaseEntity * ) )(&::CBaseEntity::DeathNotice)
            , (void ( CLogicalEntity_wrapper::* )( ::CBaseEntity * ) )(&CLogicalEntity_wrapper::default_DeathNotice)
            , ( bp::arg("pVictim") ) )    
        .def( 
            "DoImpactEffect"
            , (void ( ::CBaseEntity::* )( ::trace_t &,int ) )(&::CBaseEntity::DoImpactEffect)
            , (void ( CLogicalEntity_wrapper::* )( ::trace_t &,int ) )(&CLogicalEntity_wrapper::default_DoImpactEffect)
            , ( bp::arg("tr"), bp::arg("nDamageType") ) )    
        .def( 
            "DrawDebugGeometryOverlays"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::DrawDebugGeometryOverlays)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_DrawDebugGeometryOverlays) )    
        .def( 
            "DrawDebugTextOverlays"
            , (int ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::DrawDebugTextOverlays)
            , (int ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_DrawDebugTextOverlays) )    
        .def( 
            "EndTouch"
            , (void ( ::CBaseEntity::* )( ::CBaseEntity * ) )(&::CBaseEntity::EndTouch)
            , (void ( CLogicalEntity_wrapper::* )( ::CBaseEntity * ) )(&CLogicalEntity_wrapper::default_EndTouch)
            , ( bp::arg("pOther") ) )    
        .def( 
            "Event_Killed"
        ...
        .def( 
            ...
            , (::IMouse * ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_GetIMouse)
            , bp::return_value_policy< bp::return_by_value >() )    
        .def( 
            "GetTracerType"
            , (char const * ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::GetTracerType)
            , (char const * ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_GetTracerType) )    
        .def( 
            "KeyValue"
            , (bool ( ::CBaseEntity::* )( char const *,float ) )(&::CBaseEntity::KeyValue)
            , (bool ( CLogicalEntity_wrapper::* )( char const *,float ) )(&CLogicalEntity_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("flValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::CBaseEntity::* )( char const *,int ) )(&::CBaseEntity::KeyValue)
            , (bool ( CLogicalEntity_wrapper::* )( char const *,int ) )(&CLogicalEntity_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("nValue") ) )    
        .def( 
            "KeyValue"
            , (bool ( ::CBaseEntity::* )( char const *,::Vector const & ) )(&::CBaseEntity::KeyValue)
            , (bool ( CLogicalEntity_wrapper::* )( char const *,::Vector const & ) )(&CLogicalEntity_wrapper::default_KeyValue)
            , ( bp::arg("szKeyName"), bp::arg("vecValue") ) )    
        .def( 
            "MakeTracer"
            , (void ( ::CBaseEntity::* )( ::Vector const &,::trace_t const &,int ) )(&::CBaseEntity::MakeTracer)
            , (void ( CLogicalEntity_wrapper::* )( ::Vector const &,::trace_t const &,int ) )(&CLogicalEntity_wrapper::default_MakeTracer)
            , ( bp::arg("vecTracerSrc"), bp::arg("tr"), bp::arg("iTracerType") ) )    
        .def( 
            "ModifyOrAppendCriteria"
            , (void ( ::CBaseEntity::* )( ::ResponseRules::CriteriaSet & ) )(&::CBaseEntity::ModifyOrAppendCriteria)
            , (void ( CLogicalEntity_wrapper::* )( ::ResponseRules::CriteriaSet & ) )(&CLogicalEntity_wrapper::default_ModifyOrAppendCriteria)
            , ( bp::arg("set") ) )    
        .def( 
            "OnChangeOwnerNumber"
            , (void ( ::CBaseEntity::* )( int ) )(&::CBaseEntity::OnChangeOwnerNumber)
            , (void ( CLogicalEntity_wrapper::* )( int ) )(&CLogicalEntity_wrapper::default_OnChangeOwnerNumber)
            , ( bp::arg("old_owner_number") ) )    
        .def( 
            "OnRestore"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::OnRestore)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_OnRestore) )    
        .def( 
            "OnTakeDamage"
            , (int ( ::CBaseEntity::* )( ::CTakeDamageInfo const & ) )(&::CBaseEntity::OnTakeDamage)
            , (int ( CLogicalEntity_wrapper::* )( ::CTakeDamageInfo const & ) )(&CLogicalEntity_wrapper::default_OnTakeDamage)
            , ( bp::arg("info") ) )    
        .def( 
            "PassesDamageFilter"
            , (bool ( ::CBaseEntity::* )( ::CTakeDamageInfo const & ) )(&::CBaseEntity::PassesDamageFilter)
            , (bool ( CLogicalEntity_wrapper::* )( ::CTakeDamageInfo const & ) )(&CLogicalEntity_wrapper::default_PassesDamageFilter)
            , ( bp::arg("info") ) )    
        .def( 
            "PostClientActive"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::PostClientActive)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_PostClientActive) )    
        .def( 
            "PostConstructor"
            , (void ( ::CBaseEntity::* )( char const * ) )(&::CBaseEntity::PostConstructor)
            , (void ( CLogicalEntity_wrapper::* )( char const * ) )(&CLogicalEntity_wrapper::default_PostConstructor)
            , ( bp::arg("szClassname") ) )    
        .def( 
            "Precache"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::Precache)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_Precache) )    
        .def( 
            "Restore"
            , (int ( ::CBaseEntity::* )( ::IRestore & ) )(&::CBaseEntity::Restore)
            , (int ( CLogicalEntity_wrapper::* )( ::IRestore & ) )(&CLogicalEntity_wrapper::default_Restore)
            , ( bp::arg("restore") ) )    
        .def( 
            "Spawn"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::Spawn)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_Spawn) )    
        .def( 
            "StartTouch"
            , (void ( ::CBaseEntity::* )( ::CBaseEntity * ) )(&::CBaseEntity::StartTouch)
            , (void ( CLogicalEntity_wrapper::* )( ::CBaseEntity * ) )(&CLogicalEntity_wrapper::default_StartTouch)
            , ( bp::arg("pOther") ) )    
        .def( 
            "StopLoopingSounds"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::StopLoopingSounds)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_StopLoopingSounds) )    
        .def( 
            "TraceAttack"
            , (void ( CLogicalEntity_wrapper::* )( ::CTakeDamageInfo const &,::Vector const &,::trace_t * ) )(&CLogicalEntity_wrapper::TraceAttack)
            , ( bp::arg("info"), bp::arg("vecDir"), bp::arg("ptr") ) )    
        .def( 
            "UpdateOnRemove"
            , (void ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::UpdateOnRemove)
            , (void ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_UpdateOnRemove) )    
        .def( 
            "UpdateTransmitState"
            , (int ( ::CBaseEntity::* )(  ) )(&::CBaseEntity::UpdateTransmitState)
            , (int ( CLogicalEntity_wrapper::* )(  ) )(&CLogicalEntity_wrapper::default_UpdateTransmitState) )    
        .def( 
            "VPhysicsCollision"
            , (void ( ::CBaseEntity::* )( int,::gamevcollisionevent_t * ) )(&::CBaseEntity::VPhysicsCollision)
            , (void ( CLogicalEntity_wrapper::* )( int,::gamevcollisionevent_t * ) )(&CLogicalEntity_wrapper::default_VPhysicsCollision)
            , ( bp::arg("index"), bp::arg("pEvent") ) )    
        .add_property( "lifestate", &CLogicalEntity_wrapper::m_lifeState_Get, &CLogicalEntity_wrapper::m_lifeState_Set )    
        .add_property( "takedamage", &CLogicalEntity_wrapper::m_takedamage_Get, &CLogicalEntity_wrapper::m_takedamage_Set );
