...
struct CSprite_wrapper : CSprite, bp::wrapper< CSprite > {
    ...
    virtual void Precache(  ) {
        PY_OVERRIDE_CHECK( CSprite, Precache )
        PY_OVERRIDE_LOG( _entities, CSprite, Precache )
    ...
    virtual void Spawn(  ) {
        PY_OVERRIDE_CHECK( CSprite, Spawn )
        PY_OVERRIDE_LOG( _entities, CSprite, Spawn )
    ...
    static int m_lifeState_Get( CSprite const & inst ) { return inst.m_lifeState.Get(); }

    static void m_lifeState_Set( CSprite & inst, int val ) { inst.m_lifeState.Set( val ); }

    static int m_takedamage_Get( CSprite const & inst ) { return inst.m_takedamage.Get(); }

    static void m_takedamage_Set( CSprite & inst, int val ) { inst.m_takedamage.Set( val ); }
...
void register_CSprite_class(){
    ...
    bp::class_< CSprite_wrapper, bp::bases< CBaseEntity >, boost::noncopyable >( "CSprite", bp::init< >() )    
        ...
        .def( 
            ...
            , (int ( CSprite_wrapper::* )( ::IRestore & ) )(&CSprite_wrapper::default_Restore)
            , ( bp::arg("restore") ) )    
        .def( 
            "StartTouch"
