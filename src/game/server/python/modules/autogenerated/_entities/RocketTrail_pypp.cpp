...
struct RocketTrail_wrapper : RocketTrail, bp::wrapper< RocketTrail > {
    ...
    virtual ServerClass* GetServerClass() {
        ...
        #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
        if( py_log_overrides.GetBool() )
            Msg("Calling GetServerClass(  ) of Class: RocketTrail\n");
        #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
    ...
    virtual bool TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                ...
                #if defined(_DEBUG) || defined(PY_CHECK_LOG_OVERRIDES)
                if( py_log_overrides.GetBool() )
                    Msg("Calling TestCollision( boost::ref(ray), mask, boost::ref(trace) ) of Class: RocketTrail\n");
                #endif // _DEBUG/PY_CHECK_LOG_OVERRIDES
                ...
                if( func_TestCollision.ptr() != Py_None )
                    try {
                        ...
                        PyErr_Print();
                        return this->RocketTrail::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
                    }
                else
                    return this->RocketTrail::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
            ...
            bool default_TestCollision( ::Ray_t const & ray, unsigned int mask, ::trace_t & trace ) {
                return RocketTrail::TestCollision( boost::ref(ray), mask, boost::ref(trace) );
            }
...
void register_RocketTrail_class(){
    ...
    { //::RocketTrail
        ...
        { //::RocketTrail::TestCollision
            
                typedef bool ( ::RocketTrail::*TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;
                typedef bool ( RocketTrail_wrapper::*default_TestCollision_function_type )( ::Ray_t const &,unsigned int,::trace_t & ) ;

                RocketTrail_exposer.def( 
                    "TestCollision"
                    , TestCollision_function_type(&::RocketTrail::TestCollision)
                    , default_TestCollision_function_type(&RocketTrail_wrapper::default_TestCollision)
