...
struct CBaseParticleEntity_wrapper : CBaseParticleEntity, bp::wrapper< CBaseParticleEntity > {
    ...
    virtual ServerClass* GetServerClass() {
        PY_OVERRIDE_CHECK( CBaseParticleEntity, GetServerClass )
    ...
    static int m_lifeState_Get( CBaseParticleEntity const & inst ) { return inst.m_lifeState.Get(); }

    static void m_lifeState_Set( CBaseParticleEntity & inst, int val ) { inst.m_lifeState.Set( val ); }

    static int m_takedamage_Get( CBaseParticleEntity const & inst ) { return inst.m_takedamage.Get(); }

    static void m_takedamage_Set( CBaseParticleEntity & inst, int val ) { inst.m_takedamage.Set( val ); }
...
void register_CBaseParticleEntity_class(){
    ...
    bp::class_< CBaseParticleEntity_wrapper, bp::bases< CBaseEntity >, boost::noncopyable >( "CBaseParticleEntity", bp::init< >() )    
        ...
        .def( 
            ...
            , (int ( CBaseParticleEntity_wrapper::* )( ::IRestore & ) )(&CBaseParticleEntity_wrapper::default_Restore)
            , ( bp::arg("restore") ) )    
        .def( 
            "Spawn"
        ...
        .add_property( "lifestate", &CBaseParticleEntity_wrapper::m_lifeState_Get, &CBaseParticleEntity_wrapper::m_lifeState_Set )    
        .add_property( "takedamage", &CBaseParticleEntity_wrapper::m_takedamage_Get, &CBaseParticleEntity_wrapper::m_takedamage_Set );
