...
void CBaseEntity::StepSimulationThink( float dt )
{
	...
	else
	{
		...
		// Do not run this for hl2wars. Units use their own move code.
		// But they do use the step interpolation.
		// TODO: Make this an option? Or maybe a new movetype?
#ifndef HL2WARS_DLL
		// Run simulation
		PhysicsStepRunTimestep( dt );
#endif // HL2WARS_DLL
