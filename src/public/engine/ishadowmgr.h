...
enum ShadowFlags_t
{
	...
	SHADOW_FLAGS_PROJECTTEXTUREUNLIT    = (1 << 3),

	// Update this if you add flags
	SHADOW_FLAGS_LAST_FLAG				= SHADOW_FLAGS_PROJECTTEXTUREUNLIT
};

#define SHADOW_FLAGS_PROJECTED_TEXTURE_TYPE_MASK ( SHADOW_FLAGS_FLASHLIGHT | SHADOW_FLAGS_SHADOW | SHADOW_FLAGS_SIMPLE_PROJECTION | SHADOW_FLAGS_PROJECTTEXTUREUNLIT )
