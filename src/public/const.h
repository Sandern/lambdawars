...
#define ENT_ENTRY_MASK			(( 1 << (NUM_SERIAL_NUM_BITS - 1)) - 1)

// Bit used for testing the extension
#define EXT_EXTEND_TEST_BIT		(1 << 31)

// Original
#define ORI_NUM_ENT_ENTRY_BITS		(MAX_EDICT_BITS + 2)
#define ORI_NUM_ENT_ENTRIES			(1 << ORI_NUM_ENT_ENTRY_BITS)
#define ORI_NUM_SERIAL_NUM_BITS		16 // (32 - NUM_ENT_ENTRY_BITS)
#define ORI_NUM_SERIAL_NUM_SHIFT_BITS (32 - ORI_NUM_SERIAL_NUM_BITS)
#define ORI_ENT_ENTRY_MASK			(( 1 << ORI_NUM_SERIAL_NUM_BITS) - 1)
...
#endif // USE_INCREASED_NON_NETWORKED
