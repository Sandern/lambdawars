...
bool Image::Evict()
{
	Warning("Not implemented: Image::Evict\n");
	return false;
}

int Image::GetNumFrames()
{
	Warning("Not implemented: Image::GetNumFrames");
	return 0;
}

void Image::SetFrame( int nFrame )
{
	Warning("Not implemented: Image::SetFrame");
}

HTexture Image::GetID()
{
	Warning("Not implemented: Image::GetID");
	return (HTexture)0;
}
