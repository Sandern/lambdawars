...
{
	EditablePanel::OnThink();
}

void PropertySheet::SetPageTitle( Panel *page, const char *title )
{
	VGUI_UNIMPLEMENTED(PropertySheet::SetPageTitle);
}

Panel *PropertySheet::GetTab(int i)
{
	VGUI_UNIMPLEMENTED(PropertySheet::GetTab);
	return NULL;
}

void PropertySheet::SetShowTabs( bool state )
{
	VGUI_UNIMPLEMENTED(PropertySheet::SetShowTabs);
}

void PropertySheet::LayoutTabs()
{
	VGUI_UNIMPLEMENTED(PropertySheet::LayoutTabs);
}
