...
BEGIN_DMXELEMENT_UNPACK( Label )
END_DMXELEMENT_UNPACK( Label, Label::s_pUnpackParams )
...
//-----------------------------------------------------------------------------
// Purpose: Get the hotkey for this label
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
// Purpose: Clears all images and sets the only remaining image to the passed in image
//-----------------------------------------------------------------------------
...
{
	VGUI_UNIMPLEMENTED(Button::GetSizerMinimumSize);
}
