...
//-----------------------------------------------------------------------------
// Purpose: gets the current starting line, the first line to be displayed 
//-----------------------------------------------------------------------------
int TextEntry::GetCurrentStartLine() const
{
	VGUI_UNIMPLEMENTED(TextEntry::GetCurrentStartLine);
	return 0;
}
...
{
	VGUI_UNIMPLEMENTED(TextEntry::GetSizerMinimumSize);
}

void TextEntry::SetCatchTabKey(bool state)
{
	VGUI_UNIMPLEMENTED(TextEntry::SetCatchTabKey);
}

void TextEntry::SetTabSpaces(int count)
{
	VGUI_UNIMPLEMENTED(TextEntry::SetTabSpaces);
}