...
// Purpose: Constructor
//-----------------------------------------------------------------------------
BaseInputDialog::BaseInputDialog( vgui::Panel *parent, const char *title, bool bShowCancelButton ) :
	BaseClass( parent, NULL )
{
	...
	m_pCancelButton->SetVisible(bShowCancelButton);
...
{
	VGUI_UNIMPLEMENTED(InputMessageBox::WriteDataToKeyValues);
}
