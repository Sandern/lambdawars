...
{
	VGUI_UNIMPLEMENTED(ToolWindow::OnSetFocus);
}

void ToolWindow::OnGripPanelMoved( int nNewX, int nNewY, int nNewW, int nNewH )
{
	VGUI_UNIMPLEMENTED(ToolWindow::OnGripPanelMoved);
}

void ToolWindow::OnGripPanelMoveFinished()
{
	VGUI_UNIMPLEMENTED(ToolWindow::OnGripPanelMoveFinished);
}

void ToolWindow::OnPageChanged()
{
	VGUI_UNIMPLEMENTED(ToolWindow::OnPageChanged);
}