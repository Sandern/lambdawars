...
{
	VGUI_UNIMPLEMENTED(RichText::SetTypeAheadMode);
}

int Menu::GetTypeAheadMode()
{
	VGUI_UNIMPLEMENTED(RichText::GetTypeAheadMode);
	return COMPAT_MODE;
}

void Menu::OnHotKey(wchar_t unichar)
{
	VGUI_UNIMPLEMENTED(RichText::OnHotKey);
}

void Menu::OnTypeAhead(wchar_t unichar)
{
	VGUI_UNIMPLEMENTED(RichText::OnTypeAhead);
}
