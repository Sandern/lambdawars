...
class multiple_files_t(writer.writer_t):
    ...
    def split_enums( self ):
        ...
        self.split_creators( enums_creators, '_'+self.extmodule.body.name+'_enumerations', 'register_'+self.extmodule.body.name+'_enumerations', 0 )
    ...
    def split_global_variables( self ):
        ...
        self.split_creators( creators, '_'+self.extmodule.body.name+'_global_variables', 'register_'+self.extmodule.body.name+'_global_variables', -1 )
    ...
    def split_free_functions( self ):
        ...
        self.split_creators( creators, '_'+self.extmodule.body.name+'_free_functions', 'register_'+self.extmodule.body.name+'_free_functions', -1 )
